...
**Applicable Game Version**: `2026.04.21.0000.0000`.
...
```toml
[dependencies]
icarus = { git = "https://github.com/redstrate/Icarus", branch = "2026.04.21.0000.0000", default-features = false }
```
...
```toml
[dependencies]
icarus = { git = "https://github.com/redstrate/Icarus", branch= "2026.04.21.0000.0000", features = ["Item"], default-features = false }
```

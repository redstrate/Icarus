...
impl<'a> StructuredSheet<'a> for DeepDungeonBanSheet {
    type Row = DeepDungeonBanRow<'a>;
...
impl<'a> IntoIterator for &'a DeepDungeonBanSheet {
    type Item = (u32, Vec<(u16, DeepDungeonBanRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct DeepDungeonBanRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> DeepDungeonBanRow<'a> {

...
impl<'a> StructuredSheet<'a> for CSBonusMissionTypeSheet {
    type Row = CSBonusMissionTypeRow<'a>;
...
impl<'a> IntoIterator for &'a CSBonusMissionTypeSheet {
    type Item = (u32, Vec<(u16, CSBonusMissionTypeRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct CSBonusMissionTypeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> CSBonusMissionTypeRow<'a> {

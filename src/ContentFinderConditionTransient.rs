...
impl ContentFinderConditionTransientSheet {
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<ContentFinderConditionTransientRow> {
...
impl StructuredSheet for ContentFinderConditionTransientSheet {
    type Row = ContentFinderConditionTransientRow;
...
impl<'a> IntoIterator for &'a ContentFinderConditionTransientSheet {
    type Item = (u32, Vec<(u16, ContentFinderConditionTransientRow)>);
    type IntoIter = StructuredSheetIterator<'a, ContentFinderConditionTransientSheet>;
    fn into_iter(
        self,
    ) -> StructuredSheetIterator<'a, ContentFinderConditionTransientSheet> {

...
impl<'a> StructuredSheet<'a> for LeveRewardItemSheet {
    type Row = LeveRewardItemRow<'a>;
...
impl<'a> IntoIterator for &'a LeveRewardItemSheet {
    type Item = (u32, Vec<(u16, LeveRewardItemRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct LeveRewardItemRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> LeveRewardItemRow<'a> {
    pub fn LeveRewardItemGroup(&'a self) -> [&'a Field; 8] {
        [
    ...
    pub fn ProbabilityPercent(&'a self) -> [&'a Field; 8] {
        [

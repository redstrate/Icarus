...
impl StructuredSheet for RetainerFortuneRewardRangeSheet {
    type Row = RetainerFortuneRewardRangeRow;
...
impl<'a> IntoIterator for &'a RetainerFortuneRewardRangeSheet {
    type Item = (u32, Vec<(u16, RetainerFortuneRewardRangeRow)>);
...
impl RetainerFortuneRewardRangeRow {
    pub fn PercentOfLevel<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
}

...
impl<'a> ModelSkeletonRow<'a> {
    ...
    pub fn VFXScale(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn FloatHeight(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn FloatDown(&'a self) -> &'a Field {
    ...
    pub fn FloatUp(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[13]]
    }
    pub fn Unknown8(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[14]]
    }
    pub fn LoopFlySE(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[15]]
    }
    pub fn MotionBlendType(&'a self) -> &'a Field {

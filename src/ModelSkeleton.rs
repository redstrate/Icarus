...
impl ModelSkeletonRow {
    ...
    pub fn VFXScale<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn FloatHeight<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn FloatDown<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    ...
    pub fn FloatUp<'a>(&'a self) -> &'a Field {
        &self.columns[13]
    }
    pub fn Unknown8<'a>(&'a self) -> &'a Field {
        &self.columns[14]
    }
    pub fn LoopFlySE<'a>(&'a self) -> &'a Field {
        &self.columns[15]
    }
    pub fn MotionBlendType<'a>(&'a self) -> &'a Field {
        &self.columns[16]
    }
}

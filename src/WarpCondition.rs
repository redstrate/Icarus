...
impl<'a> WarpConditionRow<'a> {
    pub fn RequiredQuest1(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[0]]
    }
    pub fn RequiredQuest2(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn RequiredQuest3(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn RequiredQuest4(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn Gil(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn QuestReward(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn ClassLevel(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn CompleteParam(&'a self) -> &'a Field {

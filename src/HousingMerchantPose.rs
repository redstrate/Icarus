...
impl<'a> StructuredSheet<'a> for HousingMerchantPoseSheet {
    type Row = HousingMerchantPoseRow<'a>;
...
impl<'a> IntoIterator for &'a HousingMerchantPoseSheet {
    type Item = (u32, Vec<(u16, HousingMerchantPoseRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct HousingMerchantPoseRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> HousingMerchantPoseRow<'a> {
    pub fn Pose(&'a self) -> &'a Field {

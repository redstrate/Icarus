...
impl<'a> StructuredSheet<'a> for EurekaMagiciteItemTypeSheet {
    type Row = EurekaMagiciteItemTypeRow<'a>;
...
impl<'a> IntoIterator for &'a EurekaMagiciteItemTypeSheet {
    type Item = (u32, Vec<(u16, EurekaMagiciteItemTypeRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct EurekaMagiciteItemTypeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> EurekaMagiciteItemTypeRow<'a> {

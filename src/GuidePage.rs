...
impl<'a> StructuredSheet<'a> for GuidePageSheet {
    type Row = GuidePageRow<'a>;
...
impl<'a> IntoIterator for &'a GuidePageSheet {
    type Item = (u32, Vec<(u16, GuidePageRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GuidePageRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GuidePageRow<'a> {
    pub fn Output(&'a self) -> &'a Field {

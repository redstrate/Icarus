...
impl<'a> StructuredSheet<'a> for YardCatalogItemListSheet {
    type Row = YardCatalogItemListRow<'a>;
...
impl<'a> IntoIterator for &'a YardCatalogItemListSheet {
    type Item = (u32, Vec<(u16, YardCatalogItemListRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct YardCatalogItemListRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> YardCatalogItemListRow<'a> {

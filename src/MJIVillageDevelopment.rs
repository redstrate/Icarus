...
impl<'a> StructuredSheet<'a> for MJIVillageDevelopmentSheet {
    type Row = MJIVillageDevelopmentRow<'a>;
...
impl<'a> IntoIterator for &'a MJIVillageDevelopmentSheet {
    type Item = (u32, Vec<(u16, MJIVillageDevelopmentRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct MJIVillageDevelopmentRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> MJIVillageDevelopmentRow<'a> {
    ...
    pub fn Behavior0(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn Behavior1(&'a self) -> &'a Field {

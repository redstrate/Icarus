...
impl MJIVillageDevelopmentSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "MJIVillageDevelopment")?;
...
impl MJIVillageDevelopmentRow {
    ...
    pub fn Behavior0<'a>(&'a self) -> &'a ColumnData {
        &self.columns[6]
    }
    pub fn Behavior1<'a>(&'a self) -> &'a ColumnData {
        &self.columns[7]
    }

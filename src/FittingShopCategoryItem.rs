...
impl<'a> StructuredSheet<'a> for FittingShopCategoryItemSheet {
    type Row = FittingShopCategoryItemRow<'a>;
...
impl<'a> IntoIterator for &'a FittingShopCategoryItemSheet {
    type Item = (u32, Vec<(u16, FittingShopCategoryItemRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct FittingShopCategoryItemRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> FittingShopCategoryItemRow<'a> {

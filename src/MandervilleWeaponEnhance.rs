...
impl<'a> MandervilleWeaponEnhanceRow<'a> {
    pub fn Materia(&'a self) -> [&'a Field; 4] {
        [
    ...
    pub fn UpgradeItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn Image(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn UpgradeCost(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn Unknown7(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[7]]
    }
    pub fn MateriaBigValueIndex(&'a self) -> [&'a Field; 4] {
        [
    ...
    pub fn MateriaSmallValueIndex(&'a self) -> [&'a Field; 4] {
        [

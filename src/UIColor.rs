...
impl UIColorRow {
    pub fn Dark<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn Light<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn ClassicFF<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn ClearBlue<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn ClearWhite<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn ClearGreen<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }

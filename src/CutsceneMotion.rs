...
impl CutsceneMotionRow {
    pub fn WALK_LOOP_SPEED<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn RUN_LOOP_SPEED<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn SLOWWALK_LOOP_SPEED<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn SLOWRUN_LOOP_SPEED<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn BATTLEWALK_LOOP_SPEED<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn BATTLERUN_LOOP_SPEED<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn DASH_LOOP_SPEED<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn TURN_CW90_FRAME<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn TURN_CCW90_FRAME<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    pub fn TURN_CW180_FRAME<'a>(&'a self) -> &'a Field {
        &self.columns[9]
    }
    pub fn TURN_CCW180_FRAME<'a>(&'a self) -> &'a Field {
        &self.columns[10]
    }
}

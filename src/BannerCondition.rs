...
impl<'a> BannerConditionRow<'a> {
    pub fn UnlockCriteria1(&'a self) -> [u32; 2] {
        [
    ...
    pub fn UnlockCriteria3(&'a self) -> u32 {
        self.row.columns[5].into_u32().copied().unwrap()
    }
    pub fn UnlockCriteria4(&'a self) -> u32 {

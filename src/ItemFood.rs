...
impl<'a> ItemFoodRow<'a> {
    ...
    pub fn EXPBonusPercent(&'a self) -> u8 {
        self.row.columns[0].into_u8().copied().unwrap()
    }
    pub fn BaseParam(&'a self) -> [u8; 3] {
        [
    ...
    pub fn IsRelative(&'a self) -> [bool; 3] {
        [

...
impl<'a> StructuredSheet<'a> for SkyIslandSubjectSheet {
    type Row = SkyIslandSubjectRow<'a>;
...
impl<'a> IntoIterator for &'a SkyIslandSubjectSheet {
    type Item = (u32, Vec<(u16, SkyIslandSubjectRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct SkyIslandSubjectRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> SkyIslandSubjectRow<'a> {

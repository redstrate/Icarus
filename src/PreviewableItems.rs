...
impl<'a> StructuredSheet<'a> for PreviewableItemsSheet {
    type Row = PreviewableItemsRow<'a>;
...
impl<'a> IntoIterator for &'a PreviewableItemsSheet {
    type Item = (u32, Vec<(u16, PreviewableItemsRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct PreviewableItemsRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> PreviewableItemsRow<'a> {

...
impl<'a> StructuredSheet<'a> for InstanceContentRewardItemSheet {
    type Row = InstanceContentRewardItemRow<'a>;
...
impl<'a> IntoIterator for &'a InstanceContentRewardItemSheet {
    type Item = (u32, Vec<(u16, InstanceContentRewardItemRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct InstanceContentRewardItemRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> InstanceContentRewardItemRow<'a> {

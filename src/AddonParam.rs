...
impl<'a> StructuredSheet<'a> for AddonParamSheet {
    type Row = AddonParamRow<'a>;
...
impl<'a> IntoIterator for &'a AddonParamSheet {
    type Item = (u32, Vec<(u16, AddonParamRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct AddonParamRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> AddonParamRow<'a> {

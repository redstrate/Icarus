...
impl<'a> StructuredSheet<'a> for ExportedSGSheet {
    type Row = ExportedSGRow<'a>;
...
impl<'a> IntoIterator for &'a ExportedSGSheet {
    type Item = (u32, Vec<(u16, ExportedSGRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct ExportedSGRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> ExportedSGRow<'a> {

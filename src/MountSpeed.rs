...
impl<'a> StructuredSheet<'a> for MountSpeedSheet {
    type Row = MountSpeedRow<'a>;
...
impl<'a> IntoIterator for &'a MountSpeedSheet {
    type Item = (u32, Vec<(u16, MountSpeedRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct MountSpeedRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> MountSpeedRow<'a> {

...
impl<'a> StructuredSheet<'a> for IKDPlayerMissionConditionSheet {
    type Row = IKDPlayerMissionConditionRow<'a>;
...
impl<'a> IntoIterator for &'a IKDPlayerMissionConditionSheet {
    type Item = (u32, Vec<(u16, IKDPlayerMissionConditionRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct IKDPlayerMissionConditionRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> IKDPlayerMissionConditionRow<'a> {

...
let exh = read_excel_sheet_header(resource, "CollectablesShopRewardScrip")?;let exd = read_excel_sheet(resource, "CollectablesShopRewardScrip", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

...
impl ActionRow {
    ...
    pub fn VFX<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn ActionTimelineHit<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn PrimaryCostValue<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn SecondaryCostValue<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn ActionCombo<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn Cast100ms<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    pub fn Recast100ms<'a>(&'a self) -> &'a Field {
        &self.columns[9]
    }
    pub fn ActionProcStatus<'a>(&'a self) -> &'a Field {
        &self.columns[10]
    }
    pub fn StatusGainSelf<'a>(&'a self) -> &'a Field {
        &self.columns[11]
    }
    pub fn Omen<'a>(&'a self) -> &'a Field {
        &self.columns[12]
    }
    pub fn OmenAlt<'a>(&'a self) -> &'a Field {
        &self.columns[13]
    }
    pub fn AnimationEnd<'a>(&'a self) -> &'a Field {
        &self.columns[14]
    }
    pub fn ActionCategory<'a>(&'a self) -> &'a Field {
        &self.columns[15]
    }
    ...
    pub fn BehaviourType<'a>(&'a self) -> &'a Field {
        &self.columns[19]
    }
    pub fn ClassJobLevel<'a>(&'a self) -> &'a Field {
        &self.columns[20]
    }
    pub fn CastType<'a>(&'a self) -> &'a Field {
        &self.columns[21]
    }
    pub fn EffectRange<'a>(&'a self) -> &'a Field {
        &self.columns[22]
    }
    pub fn XAxisModifier<'a>(&'a self) -> &'a Field {
        &self.columns[23]
    }
    pub fn PrimaryCostType<'a>(&'a self) -> &'a Field {
        &self.columns[24]
    }
    pub fn SecondaryCostType<'a>(&'a self) -> &'a Field {
        &self.columns[25]
    }
    pub fn ExtraCastTime100ms<'a>(&'a self) -> &'a Field {
        &self.columns[26]
    }
    pub fn CooldownGroup<'a>(&'a self) -> &'a Field {
        &self.columns[27]
    }
    pub fn AdditionalCooldownGroup<'a>(&'a self) -> &'a Field {
        &self.columns[28]
    }
    pub fn MaxCharges<'a>(&'a self) -> &'a Field {
        &self.columns[29]
    }
    pub fn Aspect<'a>(&'a self) -> &'a Field {
        &self.columns[30]
    }
    ...
    pub fn DeadTargetBehaviour<'a>(&'a self) -> &'a Field {
        &self.columns[38]
    }
    pub fn AttackType<'a>(&'a self) -> &'a Field {
        &self.columns[39]
    }
    pub fn Unknown8<'a>(&'a self) -> &'a Field {
        &self.columns[40]
    }
    pub fn IsRoleAction<'a>(&'a self) -> &'a Field {
        &self.columns[41]
    }
    pub fn Unknown28<'a>(&'a self) -> &'a Field {
        &self.columns[42]
    }
    pub fn CanTargetSelf<'a>(&'a self) -> &'a Field {
        &self.columns[43]
    }
    pub fn CanTargetParty<'a>(&'a self) -> &'a Field {
        &self.columns[44]
    }
    pub fn CanTargetAlliance<'a>(&'a self) -> &'a Field {
        &self.columns[45]
    }
    pub fn CanTargetHostile<'a>(&'a self) -> &'a Field {
        &self.columns[46]
    }
    pub fn CanTargetAlly<'a>(&'a self) -> &'a Field {
        &self.columns[47]
    }
    pub fn Unknown10<'a>(&'a self) -> &'a Field {
        &self.columns[48]
    }
    pub fn TargetArea<'a>(&'a self) -> &'a Field {
        &self.columns[49]
    }
    pub fn CanTargetOwnPet<'a>(&'a self) -> &'a Field {
        &self.columns[50]
    }
    pub fn CanTargetPartyPet<'a>(&'a self) -> &'a Field {
        &self.columns[51]
    }
    pub fn RequiresLineOfSight<'a>(&'a self) -> &'a Field {
        &self.columns[52]
    }
    pub fn NeedToFaceTarget<'a>(&'a self) -> &'a Field {
        &self.columns[53]
    }
    pub fn Unknown14<'a>(&'a self) -> &'a Field {
        &self.columns[54]
    }
    pub fn PreservesCombo<'a>(&'a self) -> &'a Field {
        &self.columns[55]
    }
    pub fn Unknown15<'a>(&'a self) -> &'a Field {
        &self.columns[56]
    }
    pub fn AffectsPosition<'a>(&'a self) -> &'a Field {
        &self.columns[57]
    }
    ...
    pub fn LogCastMessage<'a>(&'a self) -> &'a Field {
        &self.columns[60]
    }
    pub fn Unknown18<'a>(&'a self) -> &'a Field {
        &self.columns[61]
    }
    pub fn LogMissMessage<'a>(&'a self) -> &'a Field {
        &self.columns[62]
    }
    pub fn LogActionMessage<'a>(&'a self) -> &'a Field {
        &self.columns[63]
    }
    ...
    pub fn CanUseWhileMounted<'a>(&'a self) -> &'a Field {
        &self.columns[67]
    }
    pub fn Unknown25<'a>(&'a self) -> &'a Field {
        &self.columns[68]
    }
    pub fn IsPlayerAction<'a>(&'a self) -> &'a Field {
        &self.columns[69]
    }

...
impl ContentFinderConditionRow {
    ...
    pub fn ContentCloseCycle<'a>(&'a self) -> &'a ColumnData {
        &self.columns[45]
    }
    pub fn UnlockCriteria<'a>(&'a self) -> &'a ColumnData {
        &self.columns[46]
    }
    pub fn UnlockCriteria2<'a>(&'a self) -> &'a ColumnData {
        &self.columns[47]
    }
    ...
    pub fn UnlockType<'a>(&'a self) -> &'a ColumnData {
        &self.columns[65]
    }
    pub fn UnlockType2<'a>(&'a self) -> &'a ColumnData {
        &self.columns[66]
    }
    ...
    pub fn RaidFinderParam<'a>(&'a self) -> &'a ColumnData {
        &self.columns[70]
    }
    ...
    pub fn FixedItemLevelSync<'a>(&'a self) -> &'a ColumnData {
        &self.columns[77]
    }
    pub fn AllowUndersized<'a>(&'a self) -> &'a ColumnData {
        &self.columns[78]
    }
    pub fn NeedsMemberInEveryParty<'a>(&'a self) -> &'a ColumnData {
        &self.columns[79]
    }
    ...
    pub fn AllowMinimumIL<'a>(&'a self) -> &'a ColumnData {
        &self.columns[82]
    }
    ...
    pub fn HasOnePlayerPerJobDetails<'a>(&'a self) -> &'a ColumnData {
        &self.columns[90]
    }
    ...
    pub fn IsRegistrationHomeWorldLimited<'a>(&'a self) -> &'a ColumnData {
        &self.columns[94]
    }

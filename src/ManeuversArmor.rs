...
impl ManeuversArmorRow {
    ...
    pub fn FalconName<'a>(&'a self) -> &'a ColumnData {
        &self.columns[2]
    }
    pub fn RavenName<'a>(&'a self) -> &'a ColumnData {
        &self.columns[3]
    }
    pub fn NeutralMapIcon<'a>(&'a self) -> &'a ColumnData {
        &self.columns[4]
    }
    pub fn FalconImage<'a>(&'a self) -> &'a ColumnData {
        &self.columns[5]
    }
    pub fn RavenImage<'a>(&'a self) -> &'a ColumnData {
        &self.columns[6]
    }
    pub fn FalconMapImage<'a>(&'a self) -> &'a ColumnData {
        &self.columns[7]
    }
    pub fn RavenMapImage<'a>(&'a self) -> &'a ColumnData {
        &self.columns[8]
    }

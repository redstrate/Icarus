...
impl MirageStoreSetItemRow {
    ...
    pub fn Earrings<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn Necklace<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    pub fn Bracelets<'a>(&'a self) -> &'a Field {
        &self.columns[9]
    }
    pub fn Ring<'a>(&'a self) -> &'a Field {
        &self.columns[10]
    }
}

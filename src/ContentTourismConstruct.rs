...
impl ContentTourismConstructSheet {
    ...
    pub fn row(&self, row_id: u32) -> Option<ContentTourismConstructRow> {
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<ContentTourismConstructRow> {
...
impl<'a> StructuredSheet<'a> for ContentTourismConstructSheet {
    type Row = ContentTourismConstructRow<'a>;
    fn read_row(&self, row: &'a Row) -> Option<Self::Row> {
        Some(Self::Row { row })
    }
}
impl<'a> IntoIterator for &'a ContentTourismConstructSheet {
    type Item = (u32, Vec<(u16, ContentTourismConstructRow<'a>)>);
    type IntoIter = StructuredSheetIterator<'a, ContentTourismConstructSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, ContentTourismConstructSheet> {
...
#[derive(Debug, Clone)]
pub struct ContentTourismConstructRow<'a> {
    row: &'a Row,
}
impl<'a> ContentTourismConstructRow<'a> {

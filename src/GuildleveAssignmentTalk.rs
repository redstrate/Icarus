...
impl StructuredSheet for GuildleveAssignmentTalkSheet {
    type Row = GuildleveAssignmentTalkRow;
...
impl<'a> IntoIterator for &'a GuildleveAssignmentTalkSheet {
    type Item = (u32, Vec<(u16, GuildleveAssignmentTalkRow)>);
...
impl GuildleveAssignmentTalkRow {
    ...
    pub fn Talk<'a>(&'a self) -> [&'a Field; 8] {
        [
            &self.columns[30],
            &self.columns[31],
            &self.columns[32],

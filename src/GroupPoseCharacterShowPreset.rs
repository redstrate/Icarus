...
impl StructuredSheet for GroupPoseCharacterShowPresetSheet {
    type Row = GroupPoseCharacterShowPresetRow;
...
impl<'a> IntoIterator for &'a GroupPoseCharacterShowPresetSheet {
    type Item = (u32, Vec<(u16, GroupPoseCharacterShowPresetRow)>);

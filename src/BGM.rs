...
impl<'a> BGMRow<'a> {
    ...
    pub fn DisableRestartResetTime(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn Priority(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn SpecialMode(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn DisableRestartTimeOut(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn DisableRestart(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn PassEnd(&'a self) -> &'a Field {

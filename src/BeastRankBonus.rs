...
impl<'a> BeastRankBonusRow<'a> {
    ...
    pub fn Neutral(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn Recognized(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn Friendly(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn Trusted(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn Respected(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn Honored(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn Sworn(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[7]]
    }
    pub fn AlliedBloodsworn(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[8]]
    }
    pub fn ItemQuantity(&'a self) -> [&'a Field; 8] {
        [

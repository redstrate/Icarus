...
impl<'a> StructuredSheet<'a> for GatheringItemSheet {
    type Row = GatheringItemRow<'a>;
...
impl<'a> IntoIterator for &'a GatheringItemSheet {
    type Item = (u32, Vec<(u16, GatheringItemRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GatheringItemRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GatheringItemRow<'a> {
    pub fn Unknown0(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[0]]
    }
    pub fn SublimeVariant(&'a self) -> &'a Field {
    ...
    pub fn PerceptionReq(&'a self) -> &'a Field {
    ...
    pub fn IsHidden(&'a self) -> &'a Field {

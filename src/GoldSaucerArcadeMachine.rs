...
impl GoldSaucerArcadeMachineSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "GoldSaucerArcadeMachine")?;
    ...
    fn read_row(&self, row: &ExcelSingleRow) -> Option<GoldSaucerArcadeMachineRow> {
        ...
        let (columns, _): (Vec<ColumnData>, Vec<ExcelColumnDefinition>) = zipped
            .into_iter()
            .unzip();
        Some(GoldSaucerArcadeMachineRow {
            columns,
        })
    }
...
impl GoldSaucerArcadeMachineRow {
    ...
    pub fn Poor<'a>(&'a self) -> &'a ColumnData {
        &self.columns[1]
    }
    ...
    pub fn Good<'a>(&'a self) -> &'a ColumnData {
        &self.columns[7]
    }
    ...
    pub fn Great<'a>(&'a self) -> &'a ColumnData {
        &self.columns[13]
    }
    ...
    pub fn Excellent<'a>(&'a self) -> &'a ColumnData {
        &self.columns[19]
    }
    ...
    pub fn FailImage<'a>(&'a self) -> &'a ColumnData {
        &self.columns[28]
    }

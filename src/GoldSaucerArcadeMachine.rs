...
impl GoldSaucerArcadeMachineRow {
    ...
    pub fn Excellent<'a>(&'a self) -> &'a Field {
        &self.columns[19]
    }
    ...
    pub fn FailImage<'a>(&'a self) -> &'a Field {
        &self.columns[28]
    }

...
impl<'a> StructuredSheet<'a> for CharaCardDecorationSheet {
    type Row = CharaCardDecorationRow<'a>;
...
impl<'a> IntoIterator for &'a CharaCardDecorationSheet {
    type Item = (u32, Vec<(u16, CharaCardDecorationRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct CharaCardDecorationRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> CharaCardDecorationRow<'a> {

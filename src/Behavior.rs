...
impl<'a> StructuredSheet<'a> for BehaviorSheet {
    type Row = BehaviorRow<'a>;
...
impl<'a> IntoIterator for &'a BehaviorSheet {
    type Item = (u32, Vec<(u16, BehaviorRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct BehaviorRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> BehaviorRow<'a> {
    pub fn ContentArgument0(&'a self) -> &'a Field {
    ...
    pub fn Condition0Target(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[10]]
    }
    pub fn Condition0Type(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[11]]
    }
    pub fn Condition1Target(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[12]]
    }
    pub fn Condition1Type(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[13]]
    }
    pub fn ContentArgument1(&'a self) -> &'a Field {

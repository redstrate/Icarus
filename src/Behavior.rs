...
impl<'a> BehaviorRow<'a> {
    pub fn ContentArgument0(&'a self) -> u32 {
    ...
    pub fn Condition0Target(&'a self) -> u8 {
        self.row.columns[2].into_u8().copied().unwrap()
    }
    pub fn Condition0Type(&'a self) -> u8 {
        self.row.columns[3].into_u8().copied().unwrap()
    }
    pub fn Condition1Target(&'a self) -> u8 {
        self.row.columns[9].into_u8().copied().unwrap()
    }
    pub fn Condition1Type(&'a self) -> u8 {
        self.row.columns[10].into_u8().copied().unwrap()
    }
    pub fn ContentArgument1(&'a self) -> u8 {

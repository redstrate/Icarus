...
impl CSBonusSeasonRow {
    ...
    pub fn Category0<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn Category1<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn Category2<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn Category3<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn Text0<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn Text1<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }

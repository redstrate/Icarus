...
impl<'a> StructuredSheet<'a> for WKSItemSubCategorySheet {
    type Row = WKSItemSubCategoryRow<'a>;
...
impl<'a> IntoIterator for &'a WKSItemSubCategorySheet {
    type Item = (u32, Vec<(u16, WKSItemSubCategoryRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct WKSItemSubCategoryRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> WKSItemSubCategoryRow<'a> {

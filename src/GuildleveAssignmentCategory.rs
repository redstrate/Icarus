...
impl StructuredSheet for GuildleveAssignmentCategorySheet {
    type Row = GuildleveAssignmentCategoryRow;
...
impl<'a> IntoIterator for &'a GuildleveAssignmentCategorySheet {
    type Item = (u32, Vec<(u16, GuildleveAssignmentCategoryRow)>);
...
impl GuildleveAssignmentCategoryRow {
    pub fn Category<'a>(&'a self) -> [&'a Field; 8] {
        [
            &self.columns[0],
            &self.columns[1],
            &self.columns[2],

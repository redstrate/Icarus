...
pub struct HugeCraftworksNpcRow {
    ///""
    pub HugeCraftworksTurnInParam: [HugeCraftworksTurnInParamElement; 6],
    ///""
    pub HugeCraftworksRewardParam: [HugeCraftworksRewardParamElement; 6],
    ///""
    pub Transient: String,
    ///""
    pub EventNpc: u32,
    ///""
    pub ClassJobCategory: u16,
}

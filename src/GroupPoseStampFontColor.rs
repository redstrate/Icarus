...
impl<'a> StructuredSheet<'a> for GroupPoseStampFontColorSheet {
    type Row = GroupPoseStampFontColorRow<'a>;
...
impl<'a> IntoIterator for &'a GroupPoseStampFontColorSheet {
    type Item = (u32, Vec<(u16, GroupPoseStampFontColorRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GroupPoseStampFontColorRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GroupPoseStampFontColorRow<'a> {

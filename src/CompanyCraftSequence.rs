...
impl CompanyCraftSequenceSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "CompanyCraftSequence")?;
...
impl CompanyCraftSequenceRow {
    ...
    pub fn ResultItem<'a>(&'a self) -> &'a ColumnData {
        &self.columns[1]
    }
    ...
    pub fn CompanyCraftType<'a>(&'a self) -> &'a ColumnData {
        &self.columns[4]
    }
    pub fn CompanyCraftDraft<'a>(&'a self) -> &'a ColumnData {
        &self.columns[5]
    }
    pub fn CompanyCraftPart<'a>(&'a self) -> [&'a ColumnData; 8] {
        [
            &self.columns[6],
            &self.columns[7],
            &self.columns[8],

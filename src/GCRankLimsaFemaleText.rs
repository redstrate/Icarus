...
impl<'a> StructuredSheet<'a> for GCRankLimsaFemaleTextSheet {
    type Row = GCRankLimsaFemaleTextRow<'a>;
...
impl<'a> IntoIterator for &'a GCRankLimsaFemaleTextSheet {
    type Item = (u32, Vec<(u16, GCRankLimsaFemaleTextRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GCRankLimsaFemaleTextRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GCRankLimsaFemaleTextRow<'a> {

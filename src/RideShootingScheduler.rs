...
impl<'a> StructuredSheet<'a> for RideShootingSchedulerSheet {
    type Row = RideShootingSchedulerRow<'a>;
...
impl<'a> IntoIterator for &'a RideShootingSchedulerSheet {
    type Item = (u32, Vec<(u16, RideShootingSchedulerRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct RideShootingSchedulerRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> RideShootingSchedulerRow<'a> {

...
impl<'a> StructuredSheet<'a> for WKSPraiseUISheet {
    type Row = WKSPraiseUIRow<'a>;
...
impl<'a> IntoIterator for &'a WKSPraiseUISheet {
    type Item = (u32, Vec<(u16, WKSPraiseUIRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct WKSPraiseUIRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> WKSPraiseUIRow<'a> {

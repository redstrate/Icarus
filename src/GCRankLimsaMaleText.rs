...
impl<'a> StructuredSheet<'a> for GCRankLimsaMaleTextSheet {
    type Row = GCRankLimsaMaleTextRow<'a>;
...
impl<'a> IntoIterator for &'a GCRankLimsaMaleTextSheet {
    type Item = (u32, Vec<(u16, GCRankLimsaMaleTextRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GCRankLimsaMaleTextRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GCRankLimsaMaleTextRow<'a> {

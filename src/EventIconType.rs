...
impl EventIconTypeRow {
    pub fn NpcIconAvailable<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn MapIconAvailable<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn NpcIconInvalid<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn MapIconInvalid<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn IconRange<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
}

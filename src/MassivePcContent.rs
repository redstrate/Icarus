...
impl<'a> StructuredSheet<'a> for MassivePcContentSheet {
    type Row = MassivePcContentRow<'a>;
...
impl<'a> IntoIterator for &'a MassivePcContentSheet {
    type Item = (u32, Vec<(u16, MassivePcContentRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct MassivePcContentRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> MassivePcContentRow<'a> {

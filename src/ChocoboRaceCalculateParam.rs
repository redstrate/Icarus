...
let exh = read_excel_sheet_header(resource, "ChocoboRaceCalculateParam")?;let exd = read_excel_sheet(resource, "ChocoboRaceCalculateParam", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

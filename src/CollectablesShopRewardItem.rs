...
impl<'a> StructuredSheet<'a> for CollectablesShopRewardItemSheet {
    type Row = CollectablesShopRewardItemRow<'a>;
...
impl<'a> IntoIterator for &'a CollectablesShopRewardItemSheet {
    type Item = (u32, Vec<(u16, CollectablesShopRewardItemRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct CollectablesShopRewardItemRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> CollectablesShopRewardItemRow<'a> {
    ...
    pub fn RewardLow(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn RewardMid(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn RewardHigh(&'a self) -> &'a Field {

...
let exh = read_excel_sheet_header(resource, "GcArmyExpeditionMemberBonus")?;let exd = read_excel_sheet(resource, "GcArmyExpeditionMemberBonus", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

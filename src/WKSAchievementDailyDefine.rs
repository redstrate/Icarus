...
impl WKSAchievementDailyDefineSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "WKSAchievementDailyDefine")?;
    ...
    fn read_row(&self, row: &ExcelSingleRow) -> Option<WKSAchievementDailyDefineRow> {
        ...
        let (columns, _): (Vec<ColumnData>, Vec<ExcelColumnDefinition>) = zipped
            .into_iter()
            .unzip();
        Some(WKSAchievementDailyDefineRow {
            columns,
        })
    }
...
impl WKSAchievementDailyDefineRow {
    ...
    pub fn RewardItem<'a>(&'a self) -> [&'a ColumnData; 2] {
    ...
    pub fn SuccessPointsRequired<'a>(&'a self) -> [&'a ColumnData; 2] {
    ...
    pub fn RewardQuantity<'a>(&'a self) -> &'a ColumnData {
        &self.columns[12]
    }
}

...
impl<'a> StructuredSheet<'a> for EventPathMoveSheet {
    type Row = EventPathMoveRow<'a>;
...
impl<'a> IntoIterator for &'a EventPathMoveSheet {
    type Item = (u32, Vec<(u16, EventPathMoveRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct EventPathMoveRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> EventPathMoveRow<'a> {

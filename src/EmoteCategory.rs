...
impl EmoteCategorySheet {
    ...
    pub fn subrow(&self, row_id: u32, subrow_id: u16) -> Option<EmoteCategoryRow> {
...
impl StructuredSheet for EmoteCategorySheet {
    type Row = EmoteCategoryRow;
...
impl<'a> IntoIterator for &'a EmoteCategorySheet {
    type Item = (u32, Vec<(u16, EmoteCategoryRow)>);
    type IntoIter = StructuredSheetIterator<'a, EmoteCategorySheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, EmoteCategorySheet> {

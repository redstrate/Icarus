...
impl<'a> StructuredSheet<'a> for RideShootingTargetSchedulerSheet {
    type Row = RideShootingTargetSchedulerRow<'a>;
...
impl<'a> IntoIterator for &'a RideShootingTargetSchedulerSheet {
    type Item = (u32, Vec<(u16, RideShootingTargetSchedulerRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct RideShootingTargetSchedulerRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> RideShootingTargetSchedulerRow<'a> {

...
impl<'a> ItemActionRow<'a> {
    ...
    pub fn DataHQ(&'a self) -> [&'a Field; 9] {
        [
    ...
    pub fn CondLv(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[19]]
    }
    pub fn CondBattle(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[20]]
    }
    pub fn CondPVP(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[21]]
    }
    pub fn CondPVPOnly(&'a self) -> &'a Field {

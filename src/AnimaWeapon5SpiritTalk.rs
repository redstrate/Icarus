...
impl<'a> StructuredSheet<'a> for AnimaWeapon5SpiritTalkSheet {
    type Row = AnimaWeapon5SpiritTalkRow<'a>;
...
impl<'a> IntoIterator for &'a AnimaWeapon5SpiritTalkSheet {
    type Item = (u32, Vec<(u16, AnimaWeapon5SpiritTalkRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct AnimaWeapon5SpiritTalkRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> AnimaWeapon5SpiritTalkRow<'a> {

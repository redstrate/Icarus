...
impl<'a> StructuredSheet<'a> for ChocoboRaceChallengeSheet {
    type Row = ChocoboRaceChallengeRow<'a>;
...
impl<'a> IntoIterator for &'a ChocoboRaceChallengeSheet {
    type Item = (u32, Vec<(u16, ChocoboRaceChallengeRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct ChocoboRaceChallengeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> ChocoboRaceChallengeRow<'a> {

...
impl<'a> StructuredSheet<'a> for CabinetCategorySheet {
    type Row = CabinetCategoryRow<'a>;
...
impl<'a> IntoIterator for &'a CabinetCategorySheet {
    type Item = (u32, Vec<(u16, CabinetCategoryRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct CabinetCategoryRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> CabinetCategoryRow<'a> {

...
impl ArrayEventHandlerSheet {
    ...
    pub const STARTING_ROW: u32 = 851968u32;
...
impl StructuredSheet for ArrayEventHandlerSheet {
    type Row = ArrayEventHandlerRow;
...
impl<'a> IntoIterator for &'a ArrayEventHandlerSheet {
    type Item = (u32, Vec<(u16, ArrayEventHandlerRow)>);

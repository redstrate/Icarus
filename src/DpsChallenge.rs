...
impl<'a> StructuredSheet<'a> for DpsChallengeSheet {
    type Row = DpsChallengeRow<'a>;
...
impl<'a> IntoIterator for &'a DpsChallengeSheet {
    type Item = (u32, Vec<(u16, DpsChallengeRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct DpsChallengeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> DpsChallengeRow<'a> {
    ...
    pub fn PlayerLevel(&'a self) -> &'a Field {

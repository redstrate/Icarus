...
impl WKSDevGradeRow {
    pub fn StageFull<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn Stage<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn IndexText2<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn IndexText<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn IndexNpc<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }

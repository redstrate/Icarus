...
impl<'a> MJICraftworksObjectRow<'a> {
    ...
    pub fn Material(&'a self) -> [&'a Field; 4] {
        [
    ...
    pub fn Amount(&'a self) -> [&'a Field; 4] {
        [
    ...
    pub fn LevelReq(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[12]]
    }
    pub fn CraftingTime(&'a self) -> &'a Field {

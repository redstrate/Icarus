...
impl FateModeRow {
    ...
    pub fn MotivationIcon<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn MotivationMapMarker<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn ObjectiveIcon<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn ObjectiveMapMarker<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
}

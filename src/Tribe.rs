...
impl TribeRow {
    ...
    pub fn STR<'a>(&'a self) -> &'a ColumnData {
        &self.columns[4]
    }
    pub fn VIT<'a>(&'a self) -> &'a ColumnData {
        &self.columns[5]
    }
    pub fn DEX<'a>(&'a self) -> &'a ColumnData {
        &self.columns[6]
    }
    pub fn INT<'a>(&'a self) -> &'a ColumnData {
        &self.columns[7]
    }
    pub fn MND<'a>(&'a self) -> &'a ColumnData {
        &self.columns[8]
    }
    pub fn PIE<'a>(&'a self) -> &'a ColumnData {
        &self.columns[9]
    }
}

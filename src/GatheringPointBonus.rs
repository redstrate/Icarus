...
impl<'a> StructuredSheet<'a> for GatheringPointBonusSheet {
    type Row = GatheringPointBonusRow<'a>;
...
impl<'a> IntoIterator for &'a GatheringPointBonusSheet {
    type Item = (u32, Vec<(u16, GatheringPointBonusRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GatheringPointBonusRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GatheringPointBonusRow<'a> {
    pub fn ConditionValue(&'a self) -> &'a Field {
    ...
    pub fn BonusValue(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn Unknown2(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn Condition(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn BonusType(&'a self) -> &'a Field {

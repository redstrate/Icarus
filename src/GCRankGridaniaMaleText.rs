...
impl<'a> StructuredSheet<'a> for GCRankGridaniaMaleTextSheet {
    type Row = GCRankGridaniaMaleTextRow<'a>;
...
impl<'a> IntoIterator for &'a GCRankGridaniaMaleTextSheet {
    type Item = (u32, Vec<(u16, GCRankGridaniaMaleTextRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GCRankGridaniaMaleTextRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GCRankGridaniaMaleTextRow<'a> {

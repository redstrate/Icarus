...
impl StructuredSheet for DefaultTalkLipSyncTypeSheet {
    type Row = DefaultTalkLipSyncTypeRow;
...
impl<'a> IntoIterator for &'a DefaultTalkLipSyncTypeSheet {
    type Item = (u32, Vec<(u16, DefaultTalkLipSyncTypeRow)>);

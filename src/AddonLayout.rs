...
impl<'a> StructuredSheet<'a> for AddonLayoutSheet {
    type Row = AddonLayoutRow<'a>;
...
impl<'a> IntoIterator for &'a AddonLayoutSheet {
    type Item = (u32, Vec<(u16, AddonLayoutRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct AddonLayoutRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> AddonLayoutRow<'a> {

...
impl<S: StructuredSheet> StructuredSheetIterator<'_, S> {
    ...
    pub fn flatten_subrows(&self) -> StructuredRowIterator<S> {
...
impl<S: StructuredSheet> Iterator for StructuredSheetIterator<'_, S> {
...
impl<S: StructuredSheet> Iterator for StructuredRowIterator<'_, S> {
    type Item = (u32, S::Row);

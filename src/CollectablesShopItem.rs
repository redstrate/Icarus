...
impl CollectablesShopItemRow {
    ...
    pub fn LevelMin<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn LevelMax<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn CollectablesShopRefine<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn CollectablesShopRewardScrip<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn CollectablesShopItemGroup<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }

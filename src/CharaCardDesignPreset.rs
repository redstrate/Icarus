...
impl CharaCardDesignPresetRow {
    ...
    pub fn BasePlate<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn Backing<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn PatternOverlay<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn PortraitFrame<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn PlateFrame<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn Accent<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn SortKey<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn TopBorder<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    pub fn BottomBorder<'a>(&'a self) -> &'a Field {
        &self.columns[9]
    }
}

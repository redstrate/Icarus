...
impl<'a> RelicNoteRow<'a> {
    ...
    pub fn MonsterNoteTargetCommon(&'a self) -> [&'a Field; 10] {
        [
    ...
    pub fn MonsterNoteTargetNM(&'a self) -> [&'a Field; 3] {
        [
    ...
    pub fn PlaceNameFate(&'a self) -> [&'a Field; 3] {
        [
    ...
    pub fn MonsterCount(&'a self) -> [&'a Field; 10] {
        [

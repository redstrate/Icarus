...
impl DynamicEventUITypeSheet {
    ...
    pub fn row(&self, row_id: u32) -> Option<DynamicEventUITypeRow> {
        let row = &self.sheet.row(row_id)?;
        self.read_row(row)
    }
    /// Fetches the specified subrow from the sheet.
    pub fn subrow(&self, row_id: u32, subrow_id: u16) -> Option<DynamicEventUITypeRow> {
...
impl<'a> StructuredSheet<'a> for DynamicEventUITypeSheet {
    type Row = DynamicEventUITypeRow<'a>;
...
impl<'a> IntoIterator for &'a DynamicEventUITypeSheet {
    type Item = (u32, Vec<(u16, DynamicEventUITypeRow<'a>)>);
    type IntoIter = StructuredSheetIterator<'a, DynamicEventUITypeSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, DynamicEventUITypeSheet> {
...
#[derive(Debug, Clone)]
pub struct DynamicEventUITypeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> DynamicEventUITypeRow<'a> {

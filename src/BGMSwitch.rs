...
impl<'a> StructuredSheet<'a> for BGMSwitchSheet {
    type Row = BGMSwitchRow<'a>;
...
impl<'a> IntoIterator for &'a BGMSwitchSheet {
    type Item = (u32, Vec<(u16, BGMSwitchRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct BGMSwitchRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> BGMSwitchRow<'a> {
    ...
    pub fn BGMSystemDefine(&'a self) -> &'a Field {

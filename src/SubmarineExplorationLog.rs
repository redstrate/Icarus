...
impl SubmarineExplorationLogSheet {
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<SubmarineExplorationLogRow> {
...
impl StructuredSheet for SubmarineExplorationLogSheet {
    type Row = SubmarineExplorationLogRow;
...
impl<'a> IntoIterator for &'a SubmarineExplorationLogSheet {
    type Item = (u32, Vec<(u16, SubmarineExplorationLogRow)>);
    type IntoIter = StructuredSheetIterator<'a, SubmarineExplorationLogSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, SubmarineExplorationLogSheet> {

...
impl<'a> StructuredSheet<'a> for WKSFortunePatternUIPlaceSheet {
    type Row = WKSFortunePatternUIPlaceRow<'a>;
...
impl<'a> IntoIterator for &'a WKSFortunePatternUIPlaceSheet {
    type Item = (u32, Vec<(u16, WKSFortunePatternUIPlaceRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct WKSFortunePatternUIPlaceRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> WKSFortunePatternUIPlaceRow<'a> {

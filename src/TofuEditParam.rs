...
impl StructuredSheet for TofuEditParamSheet {
    type Row = TofuEditParamRow;
...
impl<'a> IntoIterator for &'a TofuEditParamSheet {
    type Item = (u32, Vec<(u16, TofuEditParamRow)>);
...
impl TofuEditParamRow {
    ...
    pub fn Default<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn Minimum<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn Maximum<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }

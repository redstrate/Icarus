...
impl<'a> StructuredSheet<'a> for ContentsNoteRewardEurekaEXPSheet {
    type Row = ContentsNoteRewardEurekaEXPRow<'a>;
...
impl<'a> IntoIterator for &'a ContentsNoteRewardEurekaEXPSheet {
    type Item = (u32, Vec<(u16, ContentsNoteRewardEurekaEXPRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct ContentsNoteRewardEurekaEXPRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> ContentsNoteRewardEurekaEXPRow<'a> {

...
impl<'a> StructuredSheet<'a> for WKSAchievementRewardItemSheet {
    type Row = WKSAchievementRewardItemRow<'a>;
    fn read_row(&self, row: &'a Row) -> Option<Self::Row> {
        Some(Self::Row { row })
    }
}
impl<'a> IntoIterator for &'a WKSAchievementRewardItemSheet {
    type Item = (u32, Vec<(u16, WKSAchievementRewardItemRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct WKSAchievementRewardItemRow<'a> {
    row: &'a Row,
}
impl<'a> WKSAchievementRewardItemRow<'a> {

...
impl<'a> StructuredSheet<'a> for MKDRelicGrowth2MonsterSheet {
    type Row = MKDRelicGrowth2MonsterRow<'a>;
    fn read_row(&self, row: &'a Row) -> Option<Self::Row> {
        Some(Self::Row { row })
    }
}
impl<'a> IntoIterator for &'a MKDRelicGrowth2MonsterSheet {
    type Item = (u32, Vec<(u16, MKDRelicGrowth2MonsterRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct MKDRelicGrowth2MonsterRow<'a> {
    row: &'a Row,
}
impl<'a> MKDRelicGrowth2MonsterRow<'a> {

...
impl BGMSituationRow {
    pub fn DaytimeID<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn NightID<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn BattleID<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn DaybreakID<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn TwilightID<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
}

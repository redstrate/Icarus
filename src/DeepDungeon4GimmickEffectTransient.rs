...
impl StructuredSheet for DeepDungeon4GimmickEffectTransientSheet {
    type Row = DeepDungeon4GimmickEffectTransientRow;
...
impl<'a> IntoIterator for &'a DeepDungeon4GimmickEffectTransientSheet {
    type Item = (u32, Vec<(u16, DeepDungeon4GimmickEffectTransientRow)>);

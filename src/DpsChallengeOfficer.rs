...
impl<'a> StructuredSheet<'a> for DpsChallengeOfficerSheet {
    type Row = DpsChallengeOfficerRow<'a>;
...
impl<'a> IntoIterator for &'a DpsChallengeOfficerSheet {
    type Item = (u32, Vec<(u16, DpsChallengeOfficerRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct DpsChallengeOfficerRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> DpsChallengeOfficerRow<'a> {
    pub fn ChallengeName(&'a self) -> [&'a Field; 25] {
        [

...
pages.push(read_excel_sheet(resource, "BankaCraftWorksSupply", &exh, language, i)?);
...
ItemElement {ItemId: &self.columns[10],
...
ItemElement {ItemId: &self.columns[20],
...
ItemElement {ItemId: &self.columns[30],

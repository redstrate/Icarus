...
impl StructuredSheet for ItemUICategorySheet {
    type Row = ItemUICategoryRow;
...
impl<'a> IntoIterator for &'a ItemUICategorySheet {
    type Item = (u32, Vec<(u16, ItemUICategoryRow)>);
...
impl ItemUICategoryRow {
    ...
    pub fn OrderMinor<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn OrderMajor<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
}

...
impl<'a> StructuredSheet<'a> for RideShootingTargetSheet {
    type Row = RideShootingTargetRow<'a>;
...
impl<'a> IntoIterator for &'a RideShootingTargetSheet {
    type Item = (u32, Vec<(u16, RideShootingTargetRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct RideShootingTargetRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> RideShootingTargetRow<'a> {

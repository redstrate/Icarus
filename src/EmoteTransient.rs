...
impl<'a> StructuredSheet<'a> for EmoteTransientSheet {
    type Row = EmoteTransientRow<'a>;
...
impl<'a> IntoIterator for &'a EmoteTransientSheet {
    type Item = (u32, Vec<(u16, EmoteTransientRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct EmoteTransientRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> EmoteTransientRow<'a> {

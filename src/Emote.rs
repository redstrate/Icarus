...
impl<'a> EmoteRow<'a> {
    ...
    pub fn TextCommand(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn ActionTimeline(&'a self) -> [&'a Field; 7] {
        [
    ...
    pub fn LogMessageTargeted(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[12]]
    }
    pub fn LogMessageUntargeted(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[13]]
    }
    pub fn Patch(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[14]]
    }
    pub fn EmoteCategory(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[15]]
    }
    pub fn EmoteMode(&'a self) -> &'a Field {
    ...
    pub fn HasCancelEmote(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[22]]
    }
    pub fn DrawsWeapon(&'a self) -> &'a Field {

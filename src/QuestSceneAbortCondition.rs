...
impl QuestSceneAbortConditionSheet {
    ...
    pub const STARTING_ROW: u32 = 65630u32;
...
impl StructuredSheet for QuestSceneAbortConditionSheet {
    type Row = QuestSceneAbortConditionRow;
...
impl<'a> IntoIterator for &'a QuestSceneAbortConditionSheet {
    type Item = (u32, Vec<(u16, QuestSceneAbortConditionRow)>);

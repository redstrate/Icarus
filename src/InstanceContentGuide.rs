...
impl<'a> StructuredSheet<'a> for InstanceContentGuideSheet {
    type Row = InstanceContentGuideRow<'a>;
...
impl<'a> IntoIterator for &'a InstanceContentGuideSheet {
    type Item = (u32, Vec<(u16, InstanceContentGuideRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct InstanceContentGuideRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> InstanceContentGuideRow<'a> {
    pub fn Instance(&'a self) -> &'a Field {

...
impl<'a> RelicItemRow<'a> {
    pub fn GladiatorItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[0]]
    }
    pub fn PugilistItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn MarauderItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn LancerItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn ArcherItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn ConjurerItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn ThaumaturgeItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn ArcanistSMNItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[7]]
    }
    pub fn ArcanistSCHItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[8]]
    }
    pub fn ShieldItem(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[9]]
    }
    pub fn RogueItem(&'a self) -> &'a Field {

...
impl RelicItemRow {
    pub fn GladiatorItem<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn PugilistItem<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn MarauderItem<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn LancerItem<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn ArcherItem<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn ConjurerItem<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn ThaumaturgeItem<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn ArcanistSMNItem<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn ArcanistSCHItem<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    pub fn ShieldItem<'a>(&'a self) -> &'a Field {
        &self.columns[9]
    }
    pub fn RogueItem<'a>(&'a self) -> &'a Field {
        &self.columns[10]
    }

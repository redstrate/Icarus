...
impl<'a> StructuredSheet<'a> for RecipeLevelTableSheet {
    type Row = RecipeLevelTableRow<'a>;
...
impl<'a> IntoIterator for &'a RecipeLevelTableSheet {
    type Item = (u32, Vec<(u16, RecipeLevelTableRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct RecipeLevelTableRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> RecipeLevelTableRow<'a> {
    pub fn Quality(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[0]]
    }
    pub fn SuggestedCraftsmanship(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn Difficulty(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn Durability(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn ConditionsFlag(&'a self) -> &'a Field {
    ...
    pub fn ProgressDivider(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[7]]
    }
    pub fn QualityDivider(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[8]]
    }
    pub fn ProgressModifier(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[9]]
    }
    pub fn QualityModifier(&'a self) -> &'a Field {

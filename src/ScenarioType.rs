...
impl<'a> StructuredSheet<'a> for ScenarioTypeSheet {
    type Row = ScenarioTypeRow<'a>;
...
impl<'a> IntoIterator for &'a ScenarioTypeSheet {
    type Item = (u32, Vec<(u16, ScenarioTypeRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct ScenarioTypeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> ScenarioTypeRow<'a> {

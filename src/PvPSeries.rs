                ...
                LevelRewardsElement {
                    ...
                    LevelRewardCount: [
                        row
                            ...
                            .into_u16()
                            .copied()
                            .expect("Expected column 74 to be a uint16!"),
                        row
                            .columns[106]
                            .into_u16()
                            .copied()
                ...
                LevelRewardsElement {
                    ...
                    LevelRewardCount: [
                        row
                            ...
                            .into_u16()
                            .copied()
                            .expect("Expected column 75 to be a uint16!"),
                        row
                            .columns[107]
                            .into_u16()
                            .copied()
                ...
                LevelRewardsElement {
                    ...
                    LevelRewardCount: [
                        row
                            ...
                            .into_u16()
                            .copied()
                            .expect("Expected column 76 to be a uint16!"),
                        row
                            .columns[108]
                            .into_u16()
                            .copied()
                ...
                LevelRewardsElement {
                    ...
                    LevelRewardCount: [
                        row
                            ...
                            .into_u16()
                            .copied()
                            .expect("Expected column 77 to be a uint16!"),
                        row
                            .columns[109]
                            .into_u16()
                            .copied()
                ...
                LevelRewardsElement {
                    ...
                    LevelRewardCount: [
                        row
                            ...
                            .into_u16()
                            .copied()
                            .expect("Expected column 78 to be a uint16!"),
                        row
                            .columns[110]
                            .into_u16()
                            .copied()
                ...
                LevelRewardsElement {
                    ...
                    LevelRewardCount: [
                        row
                            ...
                            .into_u16()
                            .copied()
                            .expect("Expected column 79 to be a uint16!"),
                        row
                            .columns[111]
                            .into_u16()
                            .copied()
                ...
                LevelRewardsElement {
                    ...
                    LevelRewardCount: [
                        row
                            ...
                            .into_u16()
                            .copied()
                            .expect("Expected column 80 to be a uint16!"),
                        row
                            .columns[112]
                            .into_u16()
                            .copied()
...
pub struct PvPSeriesRow {
    ///""
    pub LevelRewards: [LevelRewardsElement; 32],
    ///""
    pub Unknown0: u8,
}

...
impl DynamicEventRow {
    ...
    pub fn LGBEventObject<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn LGBMapRange<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    ...
    pub fn EventType<'a>(&'a self) -> &'a Field {
        &self.columns[11]
    }
    pub fn EnemyType<'a>(&'a self) -> &'a Field {
        &self.columns[12]
    }
    pub fn MaxParticipants<'a>(&'a self) -> &'a Field {
        &self.columns[13]
    }
    ...
    pub fn SingleBattle<'a>(&'a self) -> &'a Field {
        &self.columns[16]
    }

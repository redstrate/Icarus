...
impl StructuredSheet for RecastNavimeshSheet {
    ...
    fn read_row(&self, row: &Row) -> Option<Self::Row> {
        Some(Self::Row {
            ...
            DetailMeshSampleDistance: row
                .columns[15]
                .into_f32()
                .copied()
                .expect("Expected column 15 to be a float32!"),
            DetailMeshMaxSampleError: row
                .columns[16]
                .into_f32()
                .copied()
...
pub struct RecastNavimeshRow {
    ///"Corresponds to Name from TerritoryType."
    pub Name: String,
    ///""
    pub TileSize: f32,
    ///""
    ...
    pub AgentRadius: f32,
    ///""
    pub AgentMaxClimb: f32,
    ///""
    pub AgentMaxSlope: f32,
    ///""
    pub RegionMinSize: f32,
    ///""
    pub RegionMergedSize: f32,
    ///""
    pub MaxEdgeLength: f32,
    ///""
    pub MaxEdgeError: f32,
    ///""
    pub VertsPerPoly: f32,
    ///""
    pub DetailMeshSampleDistance: f32,
    ///""
    pub DetailMeshMaxSampleError: f32,
    ///""
    pub Unknown1: f32,
    ///""
    pub Unknown2: f32,

...
impl RecastNavimeshSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "RecastNavimesh")?;
        let mut pages = Vec::new();
        for (i, _) in exh.pages.iter().enumerate() {
            pages.push(read_excel_sheet(resource, "RecastNavimesh", &exh, language, i)?);
        }
...
impl RecastNavimeshRow {
    ...
    pub fn TileSize<'a>(&'a self) -> &'a ColumnData {
        &self.columns[1]
    }
    pub fn CellSize<'a>(&'a self) -> &'a ColumnData {
        &self.columns[2]
    }
    pub fn CellHeight<'a>(&'a self) -> &'a ColumnData {
        &self.columns[3]
    }
    pub fn AgentHeight<'a>(&'a self) -> &'a ColumnData {
        &self.columns[4]
    }
    pub fn AgentRadius<'a>(&'a self) -> &'a ColumnData {
        &self.columns[5]
    }
    pub fn AgentMaxClimb<'a>(&'a self) -> &'a ColumnData {
        &self.columns[6]
    }
    pub fn AgentMaxSlope<'a>(&'a self) -> &'a ColumnData {
        &self.columns[7]
    }
    pub fn RegionMinSize<'a>(&'a self) -> &'a ColumnData {
        &self.columns[8]
    }
    pub fn RegionMergedSize<'a>(&'a self) -> &'a ColumnData {
        &self.columns[9]
    }
    pub fn MaxEdgeLength<'a>(&'a self) -> &'a ColumnData {
        &self.columns[10]
    }
    pub fn MaxEdgeError<'a>(&'a self) -> &'a ColumnData {
        &self.columns[11]
    }
    pub fn VertsPerPoly<'a>(&'a self) -> &'a ColumnData {
        &self.columns[12]
    }
    pub fn DetailMeshSampleDistance<'a>(&'a self) -> &'a ColumnData {
        &self.columns[13]
    }
    pub fn DetailMeshMaxSampleError<'a>(&'a self) -> &'a ColumnData {
        &self.columns[14]
    }

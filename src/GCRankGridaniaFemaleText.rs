...
impl<'a> StructuredSheet<'a> for GCRankGridaniaFemaleTextSheet {
    type Row = GCRankGridaniaFemaleTextRow<'a>;
...
impl<'a> IntoIterator for &'a GCRankGridaniaFemaleTextSheet {
    type Item = (u32, Vec<(u16, GCRankGridaniaFemaleTextRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GCRankGridaniaFemaleTextRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GCRankGridaniaFemaleTextRow<'a> {

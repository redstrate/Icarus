...
impl<'a> StructuredSheet<'a> for HugeCraftworksRankSheet {
    type Row = HugeCraftworksRankRow<'a>;
...
impl<'a> IntoIterator for &'a HugeCraftworksRankSheet {
    type Item = (u32, Vec<(u16, HugeCraftworksRankRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct HugeCraftworksRankRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> HugeCraftworksRankRow<'a> {
    pub fn ExpRewardPerItem(&'a self) -> &'a Field {

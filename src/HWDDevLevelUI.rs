...
impl<'a> StructuredSheet<'a> for HWDDevLevelUISheet {
    type Row = HWDDevLevelUIRow<'a>;
...
impl<'a> IntoIterator for &'a HWDDevLevelUISheet {
    type Item = (u32, Vec<(u16, HWDDevLevelUIRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct HWDDevLevelUIRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> HWDDevLevelUIRow<'a> {

...
impl ReplaceActionRow {
    ...
    pub fn ReplaceActions<'a>(&'a self) -> [&'a Field; 4] {
        [&self.columns[1], &self.columns[2], &self.columns[3], &self.columns[4]]
    }
    pub fn Param1<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn Param2<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn Param3<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn Param4<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    pub fn Type1<'a>(&'a self) -> &'a Field {
        &self.columns[9]
    }
    pub fn Type2<'a>(&'a self) -> &'a Field {
        &self.columns[10]
    }
    pub fn Type3<'a>(&'a self) -> &'a Field {
        &self.columns[11]
    }
    pub fn Type4<'a>(&'a self) -> &'a Field {
        &self.columns[12]
    }
    pub fn ReplaceSettable<'a>(&'a self) -> &'a Field {
        &self.columns[13]
    }

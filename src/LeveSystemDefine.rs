...
impl<'a> StructuredSheet<'a> for LeveSystemDefineSheet {
    type Row = LeveSystemDefineRow<'a>;
...
impl<'a> IntoIterator for &'a LeveSystemDefineSheet {
    type Item = (u32, Vec<(u16, LeveSystemDefineRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct LeveSystemDefineRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> LeveSystemDefineRow<'a> {

...
let exh = read_excel_sheet_header(resource, "GatheringRarePopTimeTable")?;let exd = read_excel_sheet(resource, "GatheringRarePopTimeTable", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

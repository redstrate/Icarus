...
impl<'a> StructuredSheet<'a> for GatheringLeveBNpcEntrySheet {
    type Row = GatheringLeveBNpcEntryRow<'a>;
...
impl<'a> IntoIterator for &'a GatheringLeveBNpcEntrySheet {
    type Item = (u32, Vec<(u16, GatheringLeveBNpcEntryRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GatheringLeveBNpcEntryRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GatheringLeveBNpcEntryRow<'a> {

...
impl<'a> StructuredSheet<'a> for MJIVillageAppearanceUISheet {
    type Row = MJIVillageAppearanceUIRow<'a>;
...
impl<'a> IntoIterator for &'a MJIVillageAppearanceUISheet {
    type Item = (u32, Vec<(u16, MJIVillageAppearanceUIRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct MJIVillageAppearanceUIRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> MJIVillageAppearanceUIRow<'a> {
    pub fn Floor(&'a self) -> &'a Field {

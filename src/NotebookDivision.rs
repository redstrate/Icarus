...
impl NotebookDivisionRow {
    ...
    pub fn SecretRecipeBookGroups<'a>(&'a self) -> [&'a ColumnData; 2] {
        [&self.columns[6], &self.columns[7]]
    }
    /// Index is CraftType
    pub fn AllowedCraftTypes<'a>(&'a self) -> [&'a ColumnData; 8] {
        [
            &self.columns[8],
            &self.columns[9],
            &self.columns[10],
    ...
    pub fn RequiresSecretRecipeBookGroupUnlock<'a>(&'a self) -> &'a ColumnData {
        &self.columns[16]
    }
}

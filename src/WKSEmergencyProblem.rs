...
impl WKSEmergencyProblemRow {
    ...
    pub fn EmergencyInfoTeleportText1<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    /// The second option to teleport
    pub fn EmergencyInfoTeleportText2<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn EventLayout<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn RequiredProgress<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }

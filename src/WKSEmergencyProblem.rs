...
impl<'a> WKSEmergencyProblemRow<'a> {
    ...
    pub fn EmergencyInfoTeleportText1(&'a self) -> u32 {
        self.row.columns[0].into_u32().copied().unwrap()
    }
    /// The second option to teleport
    pub fn EmergencyInfoTeleportText2(&'a self) -> u32 {
        self.row.columns[1].into_u32().copied().unwrap()
    }
    pub fn EventLayout(&'a self) -> u32 {
        self.row.columns[2].into_u32().copied().unwrap()
    }
    pub fn RequiredProgress(&'a self) -> u32 {

...
pub struct HWDCrafterSupplyParamsElement<'a> {
    ItemTradeIn: &'a ColumnData,
    BaseCollectableRating: &'a ColumnData,
    MidCollectableRating: &'a ColumnData,
    HighCollectableRating: &'a ColumnData,
    BaseCollectableReward: &'a ColumnData,
    MidCollectableReward: &'a ColumnData,
    HighCollectableReward: &'a ColumnData,
    BaseCollectableRewardPostPhase: &'a ColumnData,
    MidCollectableRewardPostPhase: &'a ColumnData,
    HighCollectableRewardPostPhase: &'a ColumnData,
    Level: &'a ColumnData,
    LevelMax: &'a ColumnData,
    Unknown0: &'a ColumnData,
    TermName: &'a ColumnData,
}

...
pub fn HWDCrafterSupplyParams<'a>(&'a self) -> [HWDCrafterSupplyParamsElement<'a>; 23] {
[HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[0],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[14],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[28],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[42],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[56],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[70],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[84],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[98],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[112],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[126],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[140],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[154],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[168],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[182],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[196],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[210],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[224],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[238],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[252],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[266],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[280],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[294],
...
HWDCrafterSupplyParamsElement {ItemTradeIn: &self.columns[308],

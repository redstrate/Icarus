...
impl QuestRedoChapterUIRow {
    pub fn ChapterName<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn ChapterPart<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    ...
    pub fn QuestRedoUISmall<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn QuestRedoUILarge<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn QuestRedoUIWide<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn UITab<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }

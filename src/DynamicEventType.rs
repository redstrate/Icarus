...
impl StructuredSheet for DynamicEventTypeSheet {
    type Row = DynamicEventTypeRow;
...
impl<'a> IntoIterator for &'a DynamicEventTypeSheet {
    type Item = (u32, Vec<(u16, DynamicEventTypeRow)>);
...
impl DynamicEventTypeRow {
    pub fn IconObjective0<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn IconObjective1<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
}

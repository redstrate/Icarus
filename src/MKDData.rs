...
impl MKDDataRow {
    ...
    pub fn ZoneName<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn CurrencyItem<'a>(&'a self) -> [&'a Field; 2] {
        [&self.columns[2], &self.columns[3]]
    }
    pub fn CipherItem<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn CurrencyName<'a>(&'a self) -> [&'a Field; 2] {
        [&self.columns[5], &self.columns[6]]
    }
    pub fn CipherName<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }

...
impl StructuredSheet for WKSPioneeringTrailStringSheet {
    ...
    fn read_row(&self, row: &Row) -> Option<Self::Row> {
        Some(Self::Row {
            DevelopmentLogText: row
                .columns[0]
                .into_string()
                .cloned()
                .expect("Expected column 0 to be a string!"),
            DevelopmentLogName: row
                .columns[1]
                .into_string()
                .cloned()
                .expect("Expected column 1 to be a string!"),
            DevelopmentLogDescription: row
                .columns[2]
                .into_string()
                .cloned()
...
pub struct WKSPioneeringTrailStringRow {
    ///""
    pub DevelopmentLogText: String,
    ///""
    pub DevelopmentLogName: String,
    ///""
    pub DevelopmentLogDescription: String,
}

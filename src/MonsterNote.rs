...
impl<'a> StructuredSheet<'a> for MonsterNoteSheet {
    type Row = MonsterNoteRow<'a>;
...
impl<'a> IntoIterator for &'a MonsterNoteSheet {
    type Item = (u32, Vec<(u16, MonsterNoteRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct MonsterNoteRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> MonsterNoteRow<'a> {
    ...
    pub fn MonsterNoteTarget(&'a self) -> [&'a Field; 4] {
        [

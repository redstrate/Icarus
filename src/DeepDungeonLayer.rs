...
impl<'a> DeepDungeonLayerRow<'a> {
    pub fn RoomA(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[0]]
    }
    pub fn RoomB(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn RoomC(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn DeepDungeon(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn FloorSet(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn WepMinLv(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn ArmourMinLv(&'a self) -> &'a Field {

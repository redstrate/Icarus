...
let exh = read_excel_sheet_header(resource, "EurekaLogosMixerProbability")?;let exd = read_excel_sheet(resource, "EurekaLogosMixerProbability", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

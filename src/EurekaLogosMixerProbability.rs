...
impl<'a> StructuredSheet<'a> for EurekaLogosMixerProbabilitySheet {
    type Row = EurekaLogosMixerProbabilityRow<'a>;
...
impl<'a> IntoIterator for &'a EurekaLogosMixerProbabilitySheet {
    type Item = (u32, Vec<(u16, EurekaLogosMixerProbabilityRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct EurekaLogosMixerProbabilityRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> EurekaLogosMixerProbabilityRow<'a> {

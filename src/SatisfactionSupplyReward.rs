...
impl SatisfactionSupplyRewardRow {
    ...
    pub fn SatisfactionLow<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    pub fn SatisfactionMid<'a>(&'a self) -> &'a Field {
        &self.columns[9]
    }
    pub fn SatisfactionHigh<'a>(&'a self) -> &'a Field {
        &self.columns[10]
    }
    pub fn GilLow<'a>(&'a self) -> &'a Field {
        &self.columns[11]
    }
    pub fn GilMid<'a>(&'a self) -> &'a Field {
        &self.columns[12]
    }
    pub fn GilHigh<'a>(&'a self) -> &'a Field {
        &self.columns[13]
    }
    pub fn BonusMultiplier<'a>(&'a self) -> &'a Field {
        &self.columns[14]
    }
    /// 0 == current cap
    pub fn MinLevelForSecondReward<'a>(&'a self) -> &'a Field {
        &self.columns[15]
    }
}

...
impl StructuredSheet for PublicContentTextDataSheet {
    type Row = PublicContentTextDataRow;
...
impl<'a> IntoIterator for &'a PublicContentTextDataSheet {
    type Item = (u32, Vec<(u16, PublicContentTextDataRow)>);
...
impl PublicContentTextDataRow {
    pub fn TextData<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
}

...
impl HousingIndoorTerritorySheet {
    ...
    pub const STARTING_ROW: u32 = 282u32;
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<HousingIndoorTerritoryRow> {
...
impl StructuredSheet for HousingIndoorTerritorySheet {
    type Row = HousingIndoorTerritoryRow;
...
impl<'a> IntoIterator for &'a HousingIndoorTerritorySheet {
    type Item = (u32, Vec<(u16, HousingIndoorTerritoryRow)>);
    type IntoIter = StructuredSheetIterator<'a, HousingIndoorTerritorySheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, HousingIndoorTerritorySheet> {

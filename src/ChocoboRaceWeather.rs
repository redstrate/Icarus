...
impl StructuredSheet for ChocoboRaceWeatherSheet {
    type Row = ChocoboRaceWeatherRow;
...
impl<'a> IntoIterator for &'a ChocoboRaceWeatherSheet {
    type Item = (u32, Vec<(u16, ChocoboRaceWeatherRow)>);
...
impl ChocoboRaceWeatherRow {
    pub fn WeatherType1<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn WeatherType2<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
}

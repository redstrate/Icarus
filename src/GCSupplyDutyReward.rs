...
impl<'a> StructuredSheet<'a> for GCSupplyDutyRewardSheet {
    type Row = GCSupplyDutyRewardRow<'a>;
...
impl<'a> IntoIterator for &'a GCSupplyDutyRewardSheet {
    type Item = (u32, Vec<(u16, GCSupplyDutyRewardRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GCSupplyDutyRewardRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GCSupplyDutyRewardRow<'a> {
    pub fn ExperienceSupply(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[0]]
    }
    pub fn ExperienceProvisioning(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn SealsExpertDelivery(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn SealsSupply(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn SealsProvisioning(&'a self) -> &'a Field {

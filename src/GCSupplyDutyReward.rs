...
impl<'a> GCSupplyDutyRewardRow<'a> {
    pub fn ExperienceSupply(&'a self) -> u32 {
        self.row.columns[0].into_u32().copied().unwrap()
    }
    pub fn ExperienceProvisioning(&'a self) -> u32 {
        self.row.columns[1].into_u32().copied().unwrap()
    }
    pub fn SealsExpertDelivery(&'a self) -> u32 {
        self.row.columns[2].into_u32().copied().unwrap()
    }
    pub fn SealsSupply(&'a self) -> u32 {
        self.row.columns[3].into_u32().copied().unwrap()
    }
    pub fn SealsProvisioning(&'a self) -> u32 {

...
impl StructuredSheet for GCSupplyDutyRewardSheet {
    ...
    fn read_row(&self, row: &Row) -> Option<Self::Row> {
        Some(Self::Row {
            ExperienceSupply: row
                .columns[0]
                .into_u32()
                .copied()
                .expect("Expected column 0 to be a uint32!"),
            ExperienceProvisioning: row
                .columns[1]
                .into_u32()
                .copied()
                .expect("Expected column 1 to be a uint32!"),
            SealsExpertDelivery: row
                .columns[2]
                .into_u32()
                .copied()
...
pub struct GCSupplyDutyRewardRow {
    ///""
    pub ExperienceSupply: u32,
    ///""
    pub ExperienceProvisioning: u32,
    ///""
    pub SealsExpertDelivery: u32,
    ///""
    pub SealsSupply: u32,
    ///""
    pub SealsProvisioning: u32,
}

...
impl<'a> StructuredSheet<'a> for GroupPoseStampSheet {
    type Row = GroupPoseStampRow<'a>;
...
impl<'a> IntoIterator for &'a GroupPoseStampSheet {
    type Item = (u32, Vec<(u16, GroupPoseStampRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GroupPoseStampRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GroupPoseStampRow<'a> {
    ...
    pub fn StampIcon(&'a self) -> &'a Field {

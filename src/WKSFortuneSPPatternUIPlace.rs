...
let exh = read_excel_sheet_header(resource, "WKSFortuneSPPatternUIPlace")?;let exd = read_excel_sheet(resource, "WKSFortuneSPPatternUIPlace", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

...
impl StructuredSheet for MJIMinionPopAreasSheet {
    type Row = MJIMinionPopAreasRow;
...
impl<'a> IntoIterator for &'a MJIMinionPopAreasSheet {
    type Item = (u32, Vec<(u16, MJIMinionPopAreasRow)>);
...
impl MJIMinionPopAreasRow {
    ...
    pub fn RequiredFunction<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }

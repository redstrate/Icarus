...
impl<'a> StructuredSheet<'a> for WKSTerritoryInfoSheet {
    type Row = WKSTerritoryInfoRow<'a>;
...
impl<'a> IntoIterator for &'a WKSTerritoryInfoSheet {
    type Item = (u32, Vec<(u16, WKSTerritoryInfoRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct WKSTerritoryInfoRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> WKSTerritoryInfoRow<'a> {
    ...
    pub fn MechaEventNpc(&'a self) -> &'a Field {

...
impl<'a> FishingRecordTypeRow<'a> {
    ...
    pub fn RankBRequirement(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn RankARequirement(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn RankAARequirement(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn RankAAARequirement(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn RankSRequirement(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn IsSpearfishing(&'a self) -> &'a Field {

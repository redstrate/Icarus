...
impl StructuredSheet for FishingRecordTypeSheet {
    type Row = FishingRecordTypeRow;
    fn read_row(&self, row: &Row) -> Option<Self::Row> {
        Some(Self::Row {
            ...
            RankBRequirement: row
                .columns[1]
                .into_u16()
                .copied()
                .expect("Expected column 1 to be a uint16!"),
            RankARequirement: row
                .columns[2]
                .into_u16()
                .copied()
                .expect("Expected column 2 to be a uint16!"),
            RankAARequirement: row
                .columns[3]
                .into_u16()
                .copied()
                .expect("Expected column 3 to be a uint16!"),
            RankAAARequirement: row
                .columns[4]
                .into_u16()
                .copied()
                .expect("Expected column 4 to be a uint16!"),
            RankSRequirement: row
                .columns[5]
                .into_u16()
                .copied()
...
impl<'a> IntoIterator for &'a FishingRecordTypeSheet {
    type Item = (u32, Vec<(u16, FishingRecordTypeRow)>);
...
pub struct FishingRecordTypeRow {
    ...
    pub Addon: i32,
    ///""
    pub RankBRequirement: u16,
    ///""
    pub RankARequirement: u16,
    ///""
    pub RankAARequirement: u16,
    ///""
    pub RankAAARequirement: u16,
    ///""
    pub RankSRequirement: u16,
    ///""
    pub IsSpearfishing: u8,
}

...
impl FishingRecordTypeRow {
    ...
    pub fn RankBRequirement<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn RankARequirement<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn RankAARequirement<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn RankAAARequirement<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn RankSRequirement<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn IsSpearfishing<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
}

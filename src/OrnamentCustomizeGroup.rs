...
impl<'a> StructuredSheet<'a> for OrnamentCustomizeGroupSheet {
    type Row = OrnamentCustomizeGroupRow<'a>;
...
impl<'a> IntoIterator for &'a OrnamentCustomizeGroupSheet {
    type Item = (u32, Vec<(u16, OrnamentCustomizeGroupRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct OrnamentCustomizeGroupRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> OrnamentCustomizeGroupRow<'a> {
    pub fn Customize(&'a self) -> [&'a Field; 19] {
        [

...
impl<'a> StructuredSheet<'a> for OrchestrionCategorySheet {
    type Row = OrchestrionCategoryRow<'a>;
...
impl<'a> IntoIterator for &'a OrchestrionCategorySheet {
    type Item = (u32, Vec<(u16, OrchestrionCategoryRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct OrchestrionCategoryRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> OrchestrionCategoryRow<'a> {
    ...
    pub fn HideOrder(&'a self) -> &'a Field {

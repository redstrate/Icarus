...
impl<'a> StructuredSheet<'a> for SpearfishingItemSheet {
    type Row = SpearfishingItemRow<'a>;
...
impl<'a> IntoIterator for &'a SpearfishingItemSheet {
    type Item = (u32, Vec<(u16, SpearfishingItemRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct SpearfishingItemRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> SpearfishingItemRow<'a> {
    ...
    pub fn FishingRecordType(&'a self) -> &'a Field {

...
impl<'a> StructuredSheet<'a> for GCRankUldahMaleTextSheet {
    type Row = GCRankUldahMaleTextRow<'a>;
...
impl<'a> IntoIterator for &'a GCRankUldahMaleTextSheet {
    type Item = (u32, Vec<(u16, GCRankUldahMaleTextRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct GCRankUldahMaleTextRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> GCRankUldahMaleTextRow<'a> {

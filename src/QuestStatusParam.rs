...
impl<'a> StructuredSheet<'a> for QuestStatusParamSheet {
    type Row = QuestStatusParamRow<'a>;
...
impl<'a> IntoIterator for &'a QuestStatusParamSheet {
    type Item = (u32, Vec<(u16, QuestStatusParamRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct QuestStatusParamRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> QuestStatusParamRow<'a> {

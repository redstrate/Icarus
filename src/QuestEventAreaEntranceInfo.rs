...
impl QuestEventAreaEntranceInfoSheet {
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<QuestEventAreaEntranceInfoRow> {
...
impl StructuredSheet for QuestEventAreaEntranceInfoSheet {
    type Row = QuestEventAreaEntranceInfoRow;
...
impl<'a> IntoIterator for &'a QuestEventAreaEntranceInfoSheet {
    type Item = (u32, Vec<(u16, QuestEventAreaEntranceInfoRow)>);
    type IntoIter = StructuredSheetIterator<'a, QuestEventAreaEntranceInfoSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, QuestEventAreaEntranceInfoSheet> {

...
impl<'a> StructuredSheet<'a> for TriggerEffectSheet {
    type Row = TriggerEffectRow<'a>;
...
impl<'a> IntoIterator for &'a TriggerEffectSheet {
    type Item = (u32, Vec<(u16, TriggerEffectRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct TriggerEffectRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> TriggerEffectRow<'a> {

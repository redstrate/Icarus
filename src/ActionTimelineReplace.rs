...
impl ActionTimelineReplaceSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "ActionTimelineReplace")?;
...
impl ActionTimelineReplaceRow {
    pub fn Old<'a>(&'a self) -> &'a ColumnData {
        &self.columns[0]
    }
    pub fn New<'a>(&'a self) -> &'a ColumnData {
        &self.columns[1]
    }
}

...
impl<'a> StructuredSheet<'a> for ContentRewardConditionSheet {
    type Row = ContentRewardConditionRow<'a>;
...
impl<'a> IntoIterator for &'a ContentRewardConditionSheet {
    type Item = (u32, Vec<(u16, ContentRewardConditionRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct ContentRewardConditionRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> ContentRewardConditionRow<'a> {

...
impl StructuredSheet for CompanyCraftPartSheet {
    type Row = CompanyCraftPartRow;
...
impl<'a> IntoIterator for &'a CompanyCraftPartSheet {
    type Item = (u32, Vec<(u16, CompanyCraftPartRow)>);
...
impl CompanyCraftPartRow {
    pub fn CompanyCraftProcess<'a>(&'a self) -> [&'a Field; 3] {
    ...
    pub fn CompanyCraftType<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
}

...
impl StructuredSheet for DawnContentSheet {
    type Row = DawnContentRow;
    fn read_row(&self, row: &Row) -> Option<Self::Row> {
        Some(Self::Row {
            ...
            ExpBelowExMaxLvl: row
                .columns[6]
                .into_u32()
                .copied()
                .expect("Expected column 6 to be a uint32!"),
            ExpAboveExMaxLvl: row
                .columns[7]
                .into_u32()
                .copied()
...
impl<'a> IntoIterator for &'a DawnContentSheet {
    type Item = (u32, Vec<(u16, DawnContentRow)>);
...
pub struct DawnContentRow {
    ...
    pub Content: u32,
    ///""
    pub ExpBelowExMaxLvl: u32,
    ///""
    pub ExpAboveExMaxLvl: u32,
    ///""
    pub Unknown0: u32,
    ///""
    pub Unknown1: u32,

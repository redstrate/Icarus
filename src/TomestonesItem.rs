...
impl StructuredSheet for TomestonesItemSheet {
    type Row = TomestonesItemRow;
...
impl<'a> IntoIterator for &'a TomestonesItemSheet {
    type Item = (u32, Vec<(u16, TomestonesItemRow)>);
...
impl TomestonesItemRow {
    ...
    pub fn Tomestones<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn CurrencyInventorySlot<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
}

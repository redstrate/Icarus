...
impl<'a> StructuredSheet<'a> for BannerFacialSheet {
    type Row = BannerFacialRow<'a>;
...
impl<'a> IntoIterator for &'a BannerFacialSheet {
    type Item = (u32, Vec<(u16, BannerFacialRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct BannerFacialRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> BannerFacialRow<'a> {

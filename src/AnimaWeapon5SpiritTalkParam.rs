...
let exh = read_excel_sheet_header(resource, "AnimaWeapon5SpiritTalkParam")?;let exd = read_excel_sheet(resource, "AnimaWeapon5SpiritTalkParam", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

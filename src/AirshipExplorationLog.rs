...
impl AirshipExplorationLogSheet {
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<AirshipExplorationLogRow> {
...
impl StructuredSheet for AirshipExplorationLogSheet {
    type Row = AirshipExplorationLogRow;
...
impl<'a> IntoIterator for &'a AirshipExplorationLogSheet {
    type Item = (u32, Vec<(u16, AirshipExplorationLogRow)>);
    type IntoIter = StructuredSheetIterator<'a, AirshipExplorationLogSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, AirshipExplorationLogSheet> {

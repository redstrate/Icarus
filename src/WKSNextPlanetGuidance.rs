...
impl<'a> StructuredSheet<'a> for WKSNextPlanetGuidanceSheet {
    type Row = WKSNextPlanetGuidanceRow<'a>;
...
impl<'a> IntoIterator for &'a WKSNextPlanetGuidanceSheet {
    type Item = (u32, Vec<(u16, WKSNextPlanetGuidanceRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct WKSNextPlanetGuidanceRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> WKSNextPlanetGuidanceRow<'a> {

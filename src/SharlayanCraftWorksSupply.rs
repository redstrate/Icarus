...
let exh = read_excel_sheet_header(resource, "SharlayanCraftWorksSupply")?;let exd = read_excel_sheet(resource, "SharlayanCraftWorksSupply", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}

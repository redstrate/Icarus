...
impl JigsawTimeBonusSheet {
    ...
    pub fn row(&self, row_id: u32) -> Option<JigsawTimeBonusRow> {
        let row = &self.sheet.row(row_id)?;
        self.read_row(row)
    }
    /// Fetches the specified subrow from the sheet.
    pub fn subrow(&self, row_id: u32, subrow_id: u16) -> Option<JigsawTimeBonusRow> {
...
impl<'a> StructuredSheet<'a> for JigsawTimeBonusSheet {
    type Row = JigsawTimeBonusRow<'a>;
...
impl<'a> IntoIterator for &'a JigsawTimeBonusSheet {
    type Item = (u32, Vec<(u16, JigsawTimeBonusRow<'a>)>);
    type IntoIter = StructuredSheetIterator<'a, JigsawTimeBonusSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, JigsawTimeBonusSheet> {
...
#[derive(Debug, Clone)]
pub struct JigsawTimeBonusRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> JigsawTimeBonusRow<'a> {

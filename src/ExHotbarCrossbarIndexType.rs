...
impl ExHotbarCrossbarIndexTypeSheet {
    ...
    pub fn row(&self, row_id: u32) -> Option<ExHotbarCrossbarIndexTypeRow> {
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<ExHotbarCrossbarIndexTypeRow> {
...
impl<'a> StructuredSheet<'a> for ExHotbarCrossbarIndexTypeSheet {
    type Row = ExHotbarCrossbarIndexTypeRow<'a>;
    fn read_row(&self, row: &'a Row) -> Option<Self::Row> {
        Some(Self::Row { row })
    }
}
impl<'a> IntoIterator for &'a ExHotbarCrossbarIndexTypeSheet {
    type Item = (u32, Vec<(u16, ExHotbarCrossbarIndexTypeRow<'a>)>);
    type IntoIter = StructuredSheetIterator<'a, ExHotbarCrossbarIndexTypeSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, ExHotbarCrossbarIndexTypeSheet> {
...
#[derive(Debug, Clone)]
pub struct ExHotbarCrossbarIndexTypeRow<'a> {
    row: &'a Row,
}
impl<'a> ExHotbarCrossbarIndexTypeRow<'a> {

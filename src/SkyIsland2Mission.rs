...
impl SkyIsland2MissionSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "SkyIsland2Mission")?;
        let mut pages = Vec::new();
        for (i, _) in exh.pages.iter().enumerate() {
            pages
                .push(
                    read_excel_sheet(resource, "SkyIsland2Mission", &exh, language, i)?,
                );
        }
...
impl SkyIsland2MissionRow {
    ...
    pub fn Item1<'a>(&'a self) -> &'a ColumnData {
        &self.columns[5]
    }
    pub fn Item2<'a>(&'a self) -> &'a ColumnData {
        &self.columns[6]
    }
    pub fn PopRange0<'a>(&'a self) -> &'a ColumnData {
        &self.columns[7]
    }
    pub fn PopRange1<'a>(&'a self) -> &'a ColumnData {
        &self.columns[8]
    }
    pub fn PopRange2<'a>(&'a self) -> &'a ColumnData {
        &self.columns[9]
    }
    ...
    pub fn Objective2<'a>(&'a self) -> &'a ColumnData {
        &self.columns[18]
    }
    pub fn Objective3<'a>(&'a self) -> &'a ColumnData {
        &self.columns[19]
    }
    pub fn RequiredAmount1<'a>(&'a self) -> &'a ColumnData {
        &self.columns[20]
    }
    pub fn RequiredAmount2<'a>(&'a self) -> &'a ColumnData {
        &self.columns[21]
    }

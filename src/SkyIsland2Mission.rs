...
impl<'a> StructuredSheet<'a> for SkyIsland2MissionSheet {
    type Row = SkyIsland2MissionRow<'a>;
...
impl<'a> IntoIterator for &'a SkyIsland2MissionSheet {
    type Item = (u32, Vec<(u16, SkyIsland2MissionRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct SkyIsland2MissionRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> SkyIsland2MissionRow<'a> {
    ...
    pub fn PopRange0(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[7]]
    }
    pub fn PopRange1(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[8]]
    }
    pub fn PopRange2(&'a self) -> &'a Field {
    ...
    pub fn Objective2(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[18]]
    }
    pub fn Objective3(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[19]]
    }
    pub fn RequiredAmount1(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[20]]
    }
    pub fn RequiredAmount2(&'a self) -> &'a Field {

...
impl<'a> StructuredSheet<'a> for AOZArrangementSheet {
    type Row = AOZArrangementRow<'a>;
...
impl<'a> IntoIterator for &'a AOZArrangementSheet {
    type Item = (u32, Vec<(u16, AOZArrangementRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct AOZArrangementRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> AOZArrangementRow<'a> {
    pub fn AOZContentBriefingBNpc(&'a self) -> &'a Field {

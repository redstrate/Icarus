...
impl<'a> StructuredSheet<'a> for RacingChocoboGradeSheet {
    type Row = RacingChocoboGradeRow<'a>;
...
impl<'a> IntoIterator for &'a RacingChocoboGradeSheet {
    type Item = (u32, Vec<(u16, RacingChocoboGradeRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct RacingChocoboGradeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> RacingChocoboGradeRow<'a> {

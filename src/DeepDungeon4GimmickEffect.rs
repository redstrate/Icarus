...
impl StructuredSheet for DeepDungeon4GimmickEffectSheet {
    type Row = DeepDungeon4GimmickEffectRow;
...
impl<'a> IntoIterator for &'a DeepDungeon4GimmickEffectSheet {
    type Item = (u32, Vec<(u16, DeepDungeon4GimmickEffectRow)>);
...
impl DeepDungeon4GimmickEffectRow {
    pub fn StatusIcon<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }

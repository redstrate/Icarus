...
impl TerritoryTypeRow {
    ...
    pub fn Bg<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn ArrayEventHandler<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn PlaceNameRegionIcon<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn PlaceNameIcon<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn Aetheryte<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn FixedTime<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn PlaceNameRegion<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    pub fn PlaceNameZone<'a>(&'a self) -> &'a Field {
        &self.columns[8]
    }
    ...
    pub fn QuestBattle<'a>(&'a self) -> &'a Field {
        &self.columns[13]
    }
    pub fn Resident<'a>(&'a self) -> &'a Field {
        &self.columns[14]
    }
    pub fn NotoriousMonsterTerritory<'a>(&'a self) -> &'a Field {
        &self.columns[15]
    }
    pub fn BattalionMode<'a>(&'a self) -> &'a Field {
        &self.columns[16]
    }
    pub fn LoadingImage<'a>(&'a self) -> &'a Field {
        &self.columns[17]
    }
    pub fn ExclusiveType<'a>(&'a self) -> &'a Field {
        &self.columns[18]
    }
    pub fn TerritoryIntendedUse<'a>(&'a self) -> &'a Field {
        &self.columns[19]
    }
    pub fn WeatherRate<'a>(&'a self) -> &'a Field {
        &self.columns[20]
    }
    pub fn Unknown1<'a>(&'a self) -> &'a Field {
        &self.columns[21]
    }
    pub fn ExVersion<'a>(&'a self) -> &'a Field {
        &self.columns[22]
    }
    pub fn Unknown2<'a>(&'a self) -> &'a Field {
        &self.columns[23]
    }
    pub fn ZoneSharedGroup<'a>(&'a self) -> &'a Field {
        &self.columns[24]
    }
    pub fn AetherCurrentCompFlgSet<'a>(&'a self) -> &'a Field {
        &self.columns[25]
    }
    pub fn MountSpeed<'a>(&'a self) -> &'a Field {
        &self.columns[26]
    }
    pub fn IndividualWeather<'a>(&'a self) -> &'a Field {
        &self.columns[27]
    }
    pub fn AchievementIndex<'a>(&'a self) -> &'a Field {
        &self.columns[28]
    }
    ...
    pub fn PCSearch<'a>(&'a self) -> &'a Field {
        &self.columns[31]
    }
    pub fn Stealth<'a>(&'a self) -> &'a Field {
        &self.columns[32]
    }
    pub fn Mount<'a>(&'a self) -> &'a Field {
        &self.columns[33]
    }
    pub fn Unknown8<'a>(&'a self) -> &'a Field {
        &self.columns[34]
    }
    pub fn IsPvpZone<'a>(&'a self) -> &'a Field {
        &self.columns[35]
    }
    pub fn Unknown9<'a>(&'a self) -> &'a Field {
        &self.columns[36]
    }
    pub fn IsInUse<'a>(&'a self) -> &'a Field {
        &self.columns[37]
    }

...
impl<'a> RetainerTaskRow<'a> {
    ...
    pub fn RetainerTaskParameter(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn VentureCost(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn MaxTimemin(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn RequiredItemLevel(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn RequiredGathering(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn Unknown1(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[7]]
    }
    pub fn Task(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[8]]
    }
    pub fn ClassJobCategory(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[9]]
    }
    pub fn RetainerLevel(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[10]]
    }
    pub fn ConditionParam0(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[11]]
    }
    pub fn ConditionParam1(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[12]]
    }
    pub fn IsRandom(&'a self) -> &'a Field {

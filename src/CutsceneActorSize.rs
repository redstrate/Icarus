...
impl<'a> StructuredSheet<'a> for CutsceneActorSizeSheet {
    type Row = CutsceneActorSizeRow<'a>;
...
impl<'a> IntoIterator for &'a CutsceneActorSizeSheet {
    type Item = (u32, Vec<(u16, CutsceneActorSizeRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct CutsceneActorSizeRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> CutsceneActorSizeRow<'a> {

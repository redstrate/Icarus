...
impl StructuredSheet for AnimaWeaponFUITalkParamSheet {
    type Row = AnimaWeaponFUITalkParamRow;
...
impl<'a> IntoIterator for &'a AnimaWeaponFUITalkParamSheet {
    type Item = (u32, Vec<(u16, AnimaWeaponFUITalkParamRow)>);
...
impl AnimaWeaponFUITalkParamRow {
    pub fn Prologue<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn Epilogue<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
}

...
impl<'a> PetRow<'a> {
    ...
    pub fn Abilities(&'a self) -> [&'a Field; 4] {
        [
    ...
    pub fn AutoAction(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn SmallScalePercentage(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn MediumScalePercentage(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[7]]
    }
    pub fn LargeScalePercentage(&'a self) -> &'a Field {
    ...
    pub fn NonCombatSummon(&'a self) -> &'a Field {

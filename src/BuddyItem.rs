...
impl StructuredSheet for BuddyItemSheet {
    type Row = BuddyItemRow;
...
impl<'a> IntoIterator for &'a BuddyItemSheet {
    type Item = (u32, Vec<(u16, BuddyItemRow)>);
...
impl BuddyItemRow {
    ...
    pub fn UseField<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn UseTraining<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }

...
impl GuildOrderRow {
    ...
    pub fn Description1<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn Description2<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn Description3<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn CompletionBonusExp<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn RewardExp<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }
    pub fn CompletionBonusGil<'a>(&'a self) -> &'a Field {
        &self.columns[6]
    }
    pub fn RewardGil<'a>(&'a self) -> &'a Field {
        &self.columns[7]
    }
    ...
    pub fn ENpcName<'a>(&'a self) -> &'a Field {
        &self.columns[16]
    }
}

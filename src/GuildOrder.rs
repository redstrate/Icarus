...
impl<'a> GuildOrderRow<'a> {
    ...
    pub fn Description1(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[1]]
    }
    pub fn Description2(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[2]]
    }
    pub fn Description3(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[3]]
    }
    pub fn CompletionBonusExp(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[4]]
    }
    pub fn RewardExp(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[5]]
    }
    pub fn CompletionBonusGil(&'a self) -> &'a Field {
        &self.row.columns[self.index_mapping[6]]
    }
    pub fn RewardGil(&'a self) -> &'a Field {
    ...
    pub fn ENpcName(&'a self) -> &'a Field {

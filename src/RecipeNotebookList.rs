...
impl StructuredSheet for RecipeNotebookListSheet {
    type Row = RecipeNotebookListRow;
        ...
        Some(Self::Row {
            Recipe: [
                ...
                row
                    ...
                    .into_i32()
                    .copied()
                    .expect("Expected column 101 to be a int32!"),
                row
                    .columns[102]
                    .into_i32()
                    .copied()
                    .expect("Expected column 102 to be a int32!"),
                row
                    .columns[103]
                    .into_i32()
                    .copied()
                    .expect("Expected column 103 to be a int32!"),
                row
                    .columns[104]
                    .into_i32()
                    .copied()
                    .expect("Expected column 104 to be a int32!"),
                row
                    .columns[105]
                    .into_i32()
                    .copied()
                    .expect("Expected column 105 to be a int32!"),
                row
                    .columns[106]
                    .into_i32()
                    .copied()
                    .expect("Expected column 106 to be a int32!"),
                row
                    .columns[107]
                    .into_i32()
                    .copied()
                    .expect("Expected column 107 to be a int32!"),
                row
                    .columns[108]
                    .into_i32()
                    .copied()
                    .expect("Expected column 108 to be a int32!"),
                row
                    .columns[109]
                    .into_i32()
                    .copied()
                    .expect("Expected column 109 to be a int32!"),
                row
                    .columns[110]
                    .into_i32()
                    .copied()
                    .expect("Expected column 110 to be a int32!"),
                row
                    .columns[111]
                    .into_i32()
                    .copied()
                    .expect("Expected column 111 to be a int32!"),
                row
                    .columns[112]
                    .into_i32()
                    .copied()
                    .expect("Expected column 112 to be a int32!"),
                row
                    .columns[113]
                    .into_i32()
                    .copied()
                    .expect("Expected column 113 to be a int32!"),
                row
                    .columns[114]
                    .into_i32()
                    .copied()
                    .expect("Expected column 114 to be a int32!"),
                row
                    .columns[115]
                    .into_i32()
                    .copied()
                    .expect("Expected column 115 to be a int32!"),
                row
                    .columns[116]
                    .into_i32()
                    .copied()
                    .expect("Expected column 116 to be a int32!"),
                row
                    .columns[117]
                    .into_i32()
                    .copied()
                    .expect("Expected column 117 to be a int32!"),
                row
                    .columns[118]
                    .into_i32()
                    .copied()
                    .expect("Expected column 118 to be a int32!"),
                row
                    .columns[119]
                    .into_i32()
                    .copied()
                    .expect("Expected column 119 to be a int32!"),
                row
                    .columns[120]
                    .into_i32()
                    .copied()
                    .expect("Expected column 120 to be a int32!"),
                row
                    .columns[121]
                    .into_i32()
                    .copied()
...
impl<'a> IntoIterator for &'a RecipeNotebookListSheet {
    type Item = (u32, Vec<(u16, RecipeNotebookListRow)>);

...
impl ContentsNoteSheet {
    ...
    pub fn read_from<T: Resource>(resource: &mut T, language: Language) -> Option<Self> {
        let exh = read_excel_sheet_header(resource, "ContentsNote")?;
        let mut pages = Vec::new();
        for (i, _) in exh.pages.iter().enumerate() {
            pages.push(read_excel_sheet(resource, "ContentsNote", &exh, language, i)?);
        }
...
impl ContentsNoteRow {
    ...
    pub fn ReqUnlock<'a>(&'a self) -> &'a ColumnData {
        &self.columns[2]
    }
    pub fn Icon<'a>(&'a self) -> &'a ColumnData {
        &self.columns[3]
    }
    pub fn RequiredAmount<'a>(&'a self) -> &'a ColumnData {
        &self.columns[4]
    }
    pub fn ExpMultiplier<'a>(&'a self) -> &'a ColumnData {
        &self.columns[5]
    }
    pub fn GilRward<'a>(&'a self) -> &'a ColumnData {
        &self.columns[6]
    }
    pub fn ExpCap<'a>(&'a self) -> &'a ColumnData {
        &self.columns[7]
    }
    pub fn LevelUnlock<'a>(&'a self) -> &'a ColumnData {
        &self.columns[8]
    }
    pub fn HowTo<'a>(&'a self) -> &'a ColumnData {
        &self.columns[9]
    }
    ...
    pub fn Reward0<'a>(&'a self) -> &'a ColumnData {
        &self.columns[12]
    }
    pub fn Reward1<'a>(&'a self) -> &'a ColumnData {
        &self.columns[13]
    }
}

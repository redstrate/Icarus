...
impl StructuredSheet for SpearfishingComboTargetSheet {
    type Row = SpearfishingComboTargetRow;
...
impl<'a> IntoIterator for &'a SpearfishingComboTargetSheet {
    type Item = (u32, Vec<(u16, SpearfishingComboTargetRow)>);

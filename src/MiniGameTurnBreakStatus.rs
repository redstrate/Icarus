...
impl<'a> StructuredSheet<'a> for MiniGameTurnBreakStatusSheet {
    type Row = MiniGameTurnBreakStatusRow<'a>;
...
impl<'a> IntoIterator for &'a MiniGameTurnBreakStatusSheet {
    type Item = (u32, Vec<(u16, MiniGameTurnBreakStatusRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct MiniGameTurnBreakStatusRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> MiniGameTurnBreakStatusRow<'a> {

...
impl TerritoryChatRuleRow {
    pub fn Public<'a>(&'a self) -> &'a Field {
        &self.columns[0]
    }
    pub fn Shout<'a>(&'a self) -> &'a Field {
        &self.columns[1]
    }
    pub fn DutyTell<'a>(&'a self) -> &'a Field {
        &self.columns[2]
    }
    pub fn PublicTell<'a>(&'a self) -> &'a Field {
        &self.columns[3]
    }
    pub fn Party<'a>(&'a self) -> &'a Field {
        &self.columns[4]
    }
    pub fn Global<'a>(&'a self) -> &'a Field {
        &self.columns[5]
    }

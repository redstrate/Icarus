...
impl WKSMechaLivelyActorGroupSheet {
    ...
    pub fn row(&self, row_id: u32) -> Option<WKSMechaLivelyActorGroupRow> {
    ...
    pub fn subrow(
        ...
        row_id: u32,
        subrow_id: u16,
    ) -> Option<WKSMechaLivelyActorGroupRow> {
...
impl<'a> StructuredSheet<'a> for WKSMechaLivelyActorGroupSheet {
    type Row = WKSMechaLivelyActorGroupRow<'a>;
    fn read_row(&self, row: &'a Row) -> Option<Self::Row> {
        Some(Self::Row { row })
    }
}
impl<'a> IntoIterator for &'a WKSMechaLivelyActorGroupSheet {
    type Item = (u32, Vec<(u16, WKSMechaLivelyActorGroupRow<'a>)>);
    type IntoIter = StructuredSheetIterator<'a, WKSMechaLivelyActorGroupSheet>;
    fn into_iter(self) -> StructuredSheetIterator<'a, WKSMechaLivelyActorGroupSheet> {
...
#[derive(Debug, Clone)]
pub struct WKSMechaLivelyActorGroupRow<'a> {
    row: &'a Row,
}
impl<'a> WKSMechaLivelyActorGroupRow<'a> {

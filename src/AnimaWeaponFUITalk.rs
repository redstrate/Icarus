...
impl<'a> StructuredSheet<'a> for AnimaWeaponFUITalkSheet {
    type Row = AnimaWeaponFUITalkRow<'a>;
...
impl<'a> IntoIterator for &'a AnimaWeaponFUITalkSheet {
    type Item = (u32, Vec<(u16, AnimaWeaponFUITalkRow<'a>)>);
...
#[derive(Debug, Clone)]
pub struct AnimaWeaponFUITalkRow<'a> {
    row: &'a Row,
    index_mapping: Vec<usize>,
}
impl<'a> AnimaWeaponFUITalkRow<'a> {
